...
<body>
							...
							<table id="mytable" class="table table-bordered" cellspacing="0" width="100%" style="margin-bottom: 0px;">
                                <thead>
                                    <tr class="tableback"> 
                                        ...
                                        <th style="width: 6%;" class="hidden">Req. Qty</th>
                                        <th style="width: 12%;">Batch No/Exp.</th>
                                        <th style="width: 6%;">P.Shelf</th>
                                        <th style="width: 6%;">S.Shelf</th>
                                    ...
                                    <tr style='color:<s:property value="color"/>'>
                                        ...
                                        <td style="border-bottom: none !important;" class="hidden"><s:property value="reqqty"/></td> <input type="hidden" id="req<%=i%>" name="medicines[<%=i%>].reqqty" value="<s:property value="reqqty"/>"/>
                                       ...
                                       <%--  <s:if test="sstatus==1">
                                        ...
                                        <td style="border-bottom: none !important;"><s:property value="shelf"/></td>
                                        <td style="border-bottom: none !important;"><s:property value="secondary_shelf"/></td>
                                        <td><%-- <s:property value="saleqty"/> --%> <s:property value="saleqty"/></td>
                                        <td style="border-bottom: none !important;"> <input type="number" min="0" name="medicines[<%=i%>].returnqty" value="0" class="form-control" id="returnqty<%=i%>" onchange="calEditTotaltemp()" style="height: 20px !important;"/> <input type="hidden" value="<s:property value="saleqty"/>"  name="medicines[<%=i%>].saleqty" id="sale<%=i%>" class="form-control"><input type="hidden" id="tempsale<%=i%>" value="<s:property value="returnedqty"/>" /></td>
                                        ...
                                        <td style="border-bottom: none !important;" class="text-right">Rs.<label id="totalmrp<%=i%>"><s:property value="total"/></label></td>
                                          <s:if test="sstatus==1">
                                            <td style="border-bottom: none !important;" class="text-center hidden"><a href="#" onclick="deleteRowtemp(this)"><i class="fa fa-minus-circle" style="color:#c50404;font-size: 17px;padding-top: 2px;" aria-hidden="true"></i></a>  
                                          ...
                                          <s:else>
                                           <td style="border-bottom: none !important;" class="text-center hidden"><a href="#" onclick="deleteRowtemp(this)"><i class="fa fa-minus-circle" style="color:#c50404;font-size: 17px;padding-top: 2px;" aria-hidden="true"></i></a></td>
                                          </s:else>
						  ...
						  <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3">
	                            ...
	                            <a type="button" class="btn btn-primary btn-lg" style="height: 45px !important;line-height: 30px;" title="Cash Payment" onclick="updatepharmacybill()" id="returnbtn">Update</a>
                            </div>
									</div>
									</form>
								</div>
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <input type="button" class="btn btn-danger" onclick="checkeditmode()" data-dismiss="modal" value="Ok">
      </div>
    </div>
