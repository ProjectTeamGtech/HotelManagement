...
function printExcel() {
    ...
    $(".xlstable").table2excel({
					exclude: ".noExl",
					name: "Edit Pharmacy Report",
					filename: "EditbillReport",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
...
<body>
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										...
										<h4>Pharmacy Category Wise Report </h4>
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 0px;">
									 <s:form theme="simple" action="categorywisereportReport" >
										...
										<!-- <div class="col-md-6"> -->
				                           <div class="form-inline hidden-print">
					                            ...
					                            <div class="form-group hidden">
					                           		<span class="text-uppercase"><b>Pharmacy Edit Bill Report</b> &nbsp; - &nbsp;</span>
					                           </div>
				                           		<div class="form-group" style="width:14%;">
												  	<s:textfield cssClass="form-control" name="searchtext" placeholder="Search by billno/patient/product name" cssStyle="width:100%;"/>
												</div>
												<div class="form-group" style="width:7%;">
												  	<s:textfield cssClass="form-control" id="fromdate" name="FromDate" placeholder="From Date" readonly="true" cssStyle="width:100%;"/>
												</div>
												<div class="form-group" style="width:7%;">
												  	<s:textfield cssClass="form-control" id="todate" name="ToDate" placeholder="To Date" readonly="true" cssStyle="width:100%;"/>
												</div>
												
												<div class="form-group" style="width:14%;">
													<s:select list="Subcategorylist" name="Name" cssStyle="width:100%" cssClass="form-control chosen-select" listKey="id" listValue="name" headerKey="0" headerValue="Select subcategory" >
													</s:select>
												</div>
												
												<%-- <div class="form-group" style="width:14%;">
													<s:select list="userlist" name="userid" cssStyle="width:100%" cssClass="form-control chosen-select" listKey="userid" listValue="fullname" headerKey="0" headerValue="Select User" >
													</s:select>
												</div>  --%>
												...
												<div class="form-group">
													...
													<a href="#" class="btn btn-warning hidden" onclick="printDiv('page_printer3')">Print</a>
												</div>
				                           </div>
				                        <!-- </div> -->
							  ...
							  <%int i=1; %>
								<div class="" id="page_printer3">
									<%-- <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 hidden-lg hidden-sm hidden-md visible-print" style="padding: 0px;">
										<center><h3>Pharmacy Edit Bill Report <small></small></h3> </center>	
									</div> --%>
									<table class="table table-bordered table-striped xlstable" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
					                                <thead>
					                                    <tr class="loc" >
					                                        ...
					                                        <th style="width: 6%;">Subcategory Name</th>
					                                ...
					                                <tbody>
					                                    ...
					                                    <s:iterator value="Subcategoryrpt">
						                                    <tr>
						                                    <td><%=i++ %></td>
					                         	...
					                         	<s:form action="editpharmacybillreportProduct" name="paginationForm" id="paginationForm" theme="simple">
