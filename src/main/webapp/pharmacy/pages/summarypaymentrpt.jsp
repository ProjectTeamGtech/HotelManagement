		...
		<section>
			...
			<!-- page start-->
				...
				<div class="row details mainheader">
								...
								<h4>Pharmacy Payment Report Summary</h4>
								</div>
							</div>
							...
							<%-- <div class="hidden-print">
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding:0px;">
									<a style="display: none;" href="#" onclick="opencPopup('getPatientRecordEmr')" class="btn btn-primary marleft14"
										...
										<s:form action="pharmacysalereportPharmacy?action=1" theme="simple" cssClass="form-inline search">
										  ...
										  <div class="form-group" style="width: 7%;">
										    <s:textfield id="fromdate" cssStyle="width: 100%;" name="fromdate" cssClass="form-control" placeholder="From Date"/>
										  </div>
										  <%if(loginfo.isAyushman() || loginfo.isParihar()){%>
			<div class="form-group" style="width:7%;">
                                    	 <div class="form-inline hhmm">
                                   <label for="exampleInputName2">HH:MM</label><br>
									  <div class="form-group">
									    <s:select  name="fromhour" id="fromhour" list="hourList" cssClass="form-control" headerKey="00" headerValue="00"/>
									  </div>
									  <div class="form-group hidden-xs">
									    :
									  </div>
									  <div class="form-group">
									     <s:select  name="fromminute" id="fromminute" list="minuteList" cssClass="form-control mmwidthmang" headerKey="0" headerValue="Select"/>
                                    ...
                                    <%} %>
										  <div class="form-group" style="width: 7%;">
										    <s:textfield id="todate" name="todate" cssStyle="width: 100%;" cssClass="form-control" placeholder="To Date" />
										  </div>
										  <%if(loginfo.isAyushman() ||  loginfo.isParihar()){%>
			<div class="form-group" style="width:7%;">
                                    	 <div class="form-inline hhmm">
                                   <label for="exampleInputName2">HH:MM</label><br>
                                    ...
                                    <%} %>
										 ...
										 <s:select cssStyle="width: 100%;" list="#{'0':'Transaction Mode','1':'Sales Return','2':'Sales','3':'Cancel'}" name="returnbill" cssClass="form-control" theme="simple"></s:select>   
										  </div>
										  <div class="form-group" style="width: 11%;">
										    <s:select cssStyle="width: 100%;" list="#{'0':'Payment Mode','Cash':'CASH','Card':'CARD','Credit':'CREDIT','Hospital':'HOSPITAL','NEFT':'NEFT','Estimate':'ESTIMATE','Online Payment':'ONLINE PAYMENT'}" name="paymode" cssClass="form-control" theme="simple"></s:select>
										  </div>
										  <div class="form-group" style="width: 15%;">
											<s:select cssStyle="width: 100%;" list="locationListPharmacy"   theme="simple" name="location"  cssClass="form-control chosen-select" listKey="id" listValue="name" headerKey="0" headerValue="Select Location" >
											</s:select>
										  </div>
										  <div class="form-group" style="width: 13%;">
										    <s:select cssStyle="width: 100%;" list="pharmacyUserList"   theme="simple" name="userid" cssClass="form-control chosen-select" listKey="userid" listValue="fullname" headerKey="0" headerValue="Select User" >
											</s:select>
										  </div>
...
<!-- 												<a type="button" class="btn btn-primary" title="Print" onclick="printDiv('page_printer')"><i class="fa fa-print"></i></a>
 -->					<a type="button" class="btn btn-primary" title="Print" onclick="printpage()"><i class="fa fa-print"></i></a>
										  ...
										  <div class="col-lg-12 col-md-12 topback2" id="page_printer">
										   		<div class="form-inline">
										   		<div style="text-align: center;padding-top: 2%;">
										   		 <b style="font-size: 30px"><s:property value="Subcategoryname"/></b>
												   </div>
												   <div style="text-align: center;padding-top: 2%;">
												       <span style="font-size: 20px;color: green;padding-top: 1px !important;"><b>From: <s:property value="Fromdate_time"/></b><b> To <s:property value="Todate_time"/></b></span>	
												   </div>
												   <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group" style="padding-top: 5%;">
<%-- 														<span style="font-size: 20px;padding-top: 1px !important;"><b style="color: green;">Total : </b><s:property value="totalamt"/></span>
 --%>                                                  
                                                        <span style="font-size: 30px;color: green;padding-top: 1px !important;"><b>Total : <s:property value="Totalamt"/></b></span>	
                                                       
													</div>
												<tbody>
												<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group" style="padding-top: 5%;">
													 <span style="font-size: 15px;color: green;padding-top: 1px !important;"><b>Total Discount : <s:property value="Totaldiscount"/></b></span>	
														&nbsp;&nbsp;&nbsp;
														<span style="font-size: 15px;color: green;padding-top: 1px !important;"><b>Total Refund : <s:property value="TotalRefund"/></b></span>	
															
													<s:iterator value="Paymodewisepaymentlist">
													
										               &nbsp;&nbsp;&nbsp;<b style="font-size: 15px; color: green;"><s:property value="Paymode"/></b>:<b style="font-size: 15px"><s:property value="Totalamt"/></b>&nbsp;&nbsp;&nbsp;
										           
										            </s:iterator>
										             </div>
										       </tbody>
												   <div class="form-group hidden-print" style="float: right;padding-right: 67px;">
									...
									<%-- <b style="font-size: 30px"><s:property value="Subcategoryname"/></b> --%>
										<div class="hidden-print " >
												<table class="table table-striped table-bordered tablesorter hidden-print" width="100%">
											<thead>
												<tr class="tableback">
													<td style="width: 7%;text-align: centre;">Sr</td>
													<td style="width: 10%;">Bill Date</td>
													<td class="hidden">Payment Date</td>
													<td hidden style="width: 7%;">Bill UserId</td>
													<td hidden style="width: 7%;">Payment UserId</td>
													<td hidden style="width: 7%;">Bill No</td>
													<td hidden style="width: 12%;">UHID</td>
													<td style="width: 12%;">location</td>
													<td class="hidden" style="width: 4%;text-align: center;">Urgent</td>
													<td hidden style="width: 26%;">Patient Details</td>
													<td style="width: 10%;">Paymode</td>
													<td class="hidden" style="width: 3%">Note</td>
													<td style="width: 9%;text-align: centre;">Received</td>
													<td style="width: 9%;text-align: centre;">Credit</td>
													<td style="width: 9%;text-align: centre;">Refund</td>
													<td style="width: 9%;text-align: centre;">Discount</td>
													<td style="width: 7%;text-align: centre;">Card No</td>
													<!-- <td style="width: 9%;text-align: right;">Balance</td> -->
													<td style="width: 6%;text-align: centre;">Status</td>
													<!-- <th></th>
													<th></th>
													<th></th>
													<th></th> -->
											...
											<tfoot>
								               <tr style="color: green;">
								                 ...
								                 <td><b>Total</b></td>
								                 <td></td>
								                 <td style="text-align: centre;"><b>Rs.<s:property value="totalReceived"/></b></td>
								                 <td style="text-align: centre;"><b>Rs.<s:property value="totalcredit"/></b></td>
								                 <td style="text-align: centre;"><b>Rs.<s:property value="totalRefund"/></b></td>
								                 <!-- for parihar -->
								                 <td style="text-align: centre;"><b>Rs.<s:property value="Totaldisc"/></b></td>
											...
											<tbody>
												...
												<s:iterator value="priscriptionlist">
													...
													<tr style="cursor: pointer;background-color: <%=bgcolor %>" id="<s:property value="id" />" class="even pointer" ondblclick="setEmrSelectedRows(<s:property value="id" />,<s:property value="clientId" />)">
														 <td style="width: 7%;text-align: centre;"><%=(++i)%></td>
														<td style="text-align: centre;" class="">
														...
														<s:if test="returnbill>0">
														    <td style="text-align: centre;">Rs.<s:property value="total"/></td>
														</s:if>  
														<s:else>
														   <td></td>
														</s:else>
														...
														<td style="text-align: centre;"><s:property value="discount"/></td>
														<td style="text-align: centre;"><s:property value="cardno"/></td>
							...
							<s:form action="pharmacysalereportPharmacy" name="paginationForm" id="paginationForm" theme="simple">
							     ...
							     <s:hidden name="Hour"> </s:hidden>
							     <s:hidden name="Minute"> </s:hidden>
							     <s:hidden name="Fromhour"> </s:hidden>
							     <s:hidden name="Fromminute"> </s:hidden>
								<div class="col-lg-12 col-md-12 hidden-print" style="margin-top:15px;">
