...
bkLib.onDomLoaded(function() {
	...
	// new nicEditor().panelInstance('emailBodyLetter');
	 ...
	 if(document.getElementById("reqnote")){
			new nicEditor({buttonList : ['fontSize','bold','italic','underline','strikeThrough','subscript','superscript','html','image'],maxHeight : 150}).panelInstance('reqnote'); 
		}
...
<div id="followupmodal" class="modalfollowup">
	...
	<div id="vitals" class="modal fade" role="dialog">
     ...
     <!-- Booked BedModal -->
      <div class="modal fade modal-draggable" id="ipdpopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  aria-hidden="true" data-keyboard="false" data-backdrop="static">
          <div class="modal-dialog modal-md" style="width: 62%">
              <div class="modal-content">
                  <div class="modal-header bg-primary">
                  		<s:if test="freez_status==0">
							<button type="button" class="close" onclick="goreferesh()" data-dismiss="modal">
                          ...
                          <div class="col-lg-3 col-md-3" style="">
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bookdebedcss popupbedheaight popupbedpoup width100">
                                  ...
                                  <img src="popicons/avatar2.png" style="width:100%;">
                                      ...
                                      <div class="col-lg-12 col-md-12 col-xs-12" style="margin-top: 0px;padding: 0px;">
                                      <s:if test="casualtyipd==0">
                                             <span style="display: inline-flex;"><p style="font-size: 11px;">IPD NO:</p> <p id="ipdadmissionid" style="font-size: 11px;"></p> </span>
                                       </s:if>
                                         <s:elseif test="casualtyipd==2">
                                             <span style="display: inline-flex;"><p style="font-size: 11px;">DC ID:</p> <p id="ipdadmissionid" style="font-size: 11px;"></p> </span>
                                       </s:elseif>
                                       <s:else>
                                       		<span style="display: inline-flex;"><p style="font-size: 11px;">Cau ID:</p> <p id="ipdadmissionid" style="font-size: 11px;"></p> </span>
                                       </s:else> 
                                      </div>
                                      <div class="col-lg-12 col-md-12 col-xs-12" style="margin-top: 0px;padding: 0px;">
                                             <span style="display: inline-flex;"><p style="font-size: 11px;">UHID:</p>  <p id="ipdpatientid" style="font-size: 11px;"></p>  </span>
                                      </div>
 ...
 --%>
                          ...
                          <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 paddingrih ipdmodulebox">
                          <md-content class="md-padding checkboxdemoBasicUsage checkboxDemo1"> 
                          		...
                          		<div layout="row" layout-wrap="" class="layout-wrap layout-row"> 
		                			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 padrigset">
		                				<%if(loginfo.isIpd_admission()){ %>
		                                  <a href="#" onclick="openeditipdnewmethod()">
		                                      <div class="thumbnail">
                            ...
                            <%--   <s:if test="">
                              ...
                              <%if(loginfo.isIpd_discharge()){ %>
									...
									<s:else>
										<a href="#" data-toggle="modal" onclick="openfreezeerror()">
		                                      <div class="thumbnail">
		                                          <img src="cicon/dischargebed.png" alt="..." class="">
		                                          <div class="caption"><p align="center" class="fontpup">Discharge</p></div>
		                                      </div>
             ...
             <%} %>
                           ...
                           <!-- lokesh -->   	
 								...
 								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 padrigset">
                              	...
                              	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 padrigset">
                                      <a href="#" onclick="openipdshiftpatient()" >
                                      <div class="thumbnail">
                                      	  <img src="cicon/shift_patient.png" alt="..." class="">
                                          <div class="caption"><p align="center" class="fontpup" >Shift Patient</p></div>
                                      </div>
                                  </a>
                              	</div>
                              	 <s:form action="openDailynotesStatement" id="daily_note_frm" method="post" onsubmit="return redirectToDailynote()" target="formtarget">
                              	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 padrigset">
                              	    <s:hidden name="clientId" id="noteClientid"/>
									<s:hidden name="thirdParty" id="noteAccthirdparty"/>
									<s:hidden name="transactionType" id="noteAcctransactionType"/>
									<s:hidden name="location" id="noteAccLocationid"/>
									<s:hidden name="client" id="noteAccclientname"/>
									<s:hidden name = "payby" id ="noteAccPayby"></s:hidden>
									<s:hidden name="fromDate" id="noteAccfromDateid"/>
									<s:hidden name="ipdid" id="noteipdid"></s:hidden>
									<s:hidden name="toDate" id="notetoDateid"/>
									<s:hidden name="isnote" id="isnote"/>
                              	   <div class="thumbnail" onclick="redirectToDailynote()">
                                          <img src="cicon/daily_notes.png" alt="...">
                                          <div class="caption"><p align="center" class="fontpup">Daily Notes</p></div>
                                   </div>
                              	...
                              	<%if(loginfo.isBams1()) {%>
                              	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 padrigset">
                                      <a href="#" onclick="openipdrequestnote(1)" >
                                      <div class="thumbnail">
                                      	  <img src="cicon/shift_patient.png" alt="..." class="">
                                          <div class="caption"><p align="center" class="fontpup" >Request Punchkarma</p></div>
                                           <div style="margin-left: 40%; color: black;;">
                                            <span style="centre" id="notecount"></span>
                                      </div>
                                      </div>
                                  </a>
                              	</div>
                              	...
                              	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 padrigset">
                              	<%if(!loginfo.isBams()) {%>
                                      <a href="#" onclick="openipdrequestnote(0)" >
                                      <div class="thumbnail">
                                      	  <img src="cicon/shift_patient.png" alt="..." class="">
                                          <div class="caption"><p align="center" style="background-color: red;" class="fontpup" >Request Notes</p></div>
                                  ...
                                  <%-- <div style="margin-left: 40%; color: red;">
                                   ...
                                   <%-- <div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 padrigset">
                                      ...
                                      <div class="thumbnail">
                                      	  <img src="cicon/shift_patient.png" alt="..." class="">
                                          <div class="caption"><p align="center" style="background-color: red;" class="fontpup" >Request Punchkarma</p></div>
      ...
      <div class="modal fade popoverpop" id="wardselect" tabindex="-1"
		...
		<!--Ipd Shift Patient  -->
      <div class="modal fade popoverpop" id="shiftpatientpopup" style="z-index: 10000;"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-md" style="margin-right: 100px">
			<div class="modal-content" style="width: 60%">
				...
				<div class="modal-body">
					<div class="row">
						<input type="hidden" id="shiftpatient_oldwardid">
						<input type="hidden" id="shiftpatient_oldbedid">
						<input type="hidden" id="shiftpatient_admissionid">
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							 <div class="col-lg-6 col-md-6">
								   <label>Patient Name:</label>
							 </div>
							 <div class="col-lg-6 col-md-6">
								   <span id='shiftpatient_name'></span>
							 </div>
						</div>
						<br>
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							 ...
							 <div class="col-lg-6 col-md-6">
								 <div id="shiftpatient_warddiv"></div>
							 </div>
						</div>
						<br>
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							 ...
							 <div class="col-lg-6 col-md-6">
								  <div id="shiftpatient_beddiv"></div>
							 </div>
						</div>
					</div>
				...
				<div class="modal-footer" style="text-align: right;">
					<a href="#" class='btn btn-primary' id="saveshiftpatient" onclick="validateShiftPatient()">Save</a>
				</div>
			</div>
		</div>
		</div>		
		...
		<div class="modal-dialog modal-md" style="margin-right: 100px">
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
						...
						<s:textarea cssClass="form-control" rows="6" name="note"
							id="reqnotes" />
							<s:select name="otprocedureplaned" id="otprocedureplaned" list="procedureList"
					 ...
					 <label>Select Date : </label>
                          <s:textfield readonly="true" name="fromDate" id="fromDate2"
									cssClass="form-control" theme="simple" placeholder="Select date"></s:textfield>	
				</div>
	...
	<%} %>
	<div class="modal fade popoverpop" id="seeneuestpopup" style="z-index: 10000;"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-md" style="margin-right: 100px">
			<div class="modal-content" style="width: 60%">
				<div class="modal-header bg-primary">
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
						<div class="form-group">
							<h4 class="modal-title" id="completeAmtTitle">Note : <span id="setnote"></span></h4>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding:0px !important;">
        ...
        <%} %>	
        	...
        	<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12 seticons" style="min-height: 100px !important;">
	...
	aria-labelledby="lblsemdsmspopup" aria-hidden="true" data-keyboard="false" data-backdrop="static">
		<div class="modal-dialog modal-lg">
			<div class="modal-content" style="margin-left:-100px;margin-right:-100px;">
				...
				<s:hidden id="priscsavemr" value="2"></s:hidden>
	...
	aria-labelledby="lblsemdsmspopup" aria-hidden="true" data-keyboard="false" data-backdrop="static" style="background-color: rgba(0, 0, 0, 0.43);">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body" style="padding:0px;">
						<s:hidden id="savetoemr" value="2"></s:hidden>
				  ...
				  <!-- Nav tabs -->
				 			...
				 			<div id="bellheight2" class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="pres1">
                                    	...
                                    	<!--   03 OCT 2017 added investigation information -->
                                    	 <!-- tab in tabs -->
