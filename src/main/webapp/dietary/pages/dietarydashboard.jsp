...
<div  class="row manascommheader">
 <!-- <img src="dashboardicon/diet.png" class="img-responsive" style="width: 28px;margin-top: 7px;"> -->
 <img src="manasmaindashboard/images/Dietery_Icon.svg" style="filter: brightness(5);width: 2%;margin-left: 7px;">
<h4>Dietary  Dashboard </h4>
</div>
    ...
    class="fa fa-plus"></i> Create General Diet Plan</a> -->
                        ...
                        <div class="row borightset">
                        <table class="table my-table xlstable table-bordered" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th class="manastableheader" style="color: black !important;">Sr.No</th>
                                    <th class="manastableheader" style="color: black !important;">Date</th>
                                    <th class="manastableheader" style="color: black !important;">Patient Name</th>
                                    <th class="manastableheader" style="color: black !important;">Ward / Bed</th>
                                    <th class="manastableheader" style="color: black !important;">View Diet</th>
                                    <th class="manastableheader" style="color: black !important;">Diet Given</th>
                                     
                                    <th class="manastableheader" style="color: black !important;">History</th>
                                    <th class="manastableheader" style="color: black !important;">Edit</th>
                                    <th class="manastableheader" style="color: black !important;">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                            <%int i=0;%>
