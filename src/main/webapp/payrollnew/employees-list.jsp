								...
								<table class="table table-striped custom-table datatable">
									...
									<s:hidden name="emp_id"/>
										...
										<td><%=i++ %></td>
											...
											<td style="text-align: center;"><s:property value="workhour"/></td>
											...
											<td><a href="#" onclick="openPopup('generateDeclarationOtherTemplate?empid=<s:property value="emp_id"/>')"><i class="fa fa-file"></i></a></td>
										</tr>
										</s:iterator>
									</tbody>
								</table>
