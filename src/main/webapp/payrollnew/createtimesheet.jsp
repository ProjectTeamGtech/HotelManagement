...
<html lang="en">
    ...
    <body>
                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-8 col-6">
							<h4 class="page-title"> Create Time Sheet</h4>
						</div>
					...
					<!-- Search Filter -->
					<s:form action="createtimesheetAttendance">
					...
					cssClass="form-control floating datetimepicker" theme="simple" style="width:100%;" placeholder="from date"></s:textfield>
					   ...
					   <div class="col-sm-2 col-md-2 col-lg-2 col-xl-1 col-3">  
					...
					<div class="col-md-3">
					 ...
					 <h6 style="margin-top: -9px;color: white;"> Total Work Hour/Week :  <span id="workhour"><s:property	value="workhour"/></span></h6>
					 </div>
					</div>
					<div class="col-md-3">
							<div class="stats-info" style="height: 33px;background-color: #5babf9;">
					 <h6 style="margin-top: -9px;color: white;"> Recorded Hour/Week : <span id="recordhour"></span></h6>
					...
					<tbody>
						...
						<input type="hidden" id="actualvalue<%=i %>">
						<% i++; %>
						</s:iterator>
						</tr>
						<tr>
                ...
                <div class="form-group">  
					   <input type="button" onclick="saveasdraftwithval(1)" value="Save" class="btn btn-success btn-block">
					   
 				</div>&nbsp;&nbsp;&nbsp;
 				<div class="form-group">
 				<input type="button" value="Submit For Approval" onclick="saveasdraft(4)" class="btn btn-success btn-block">
 				</div>
 				</div>
					  </div> 
                </div>
