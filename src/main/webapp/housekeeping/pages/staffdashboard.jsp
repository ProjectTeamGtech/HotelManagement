		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
					...
					<h4 style="font-size: 17px; font-weight: 600; color: white">Staff Duty report</h4>
				</div>
			</div>
		</div>
		<div class="row ">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				<div>
					...
					<input type="hidden" id="invoicee" name="invoicee" /> <input
						...
						id='setp'>
					<s:form action="staffdashboardHousekeepingdashboard" id="deptfrm" theme="simple">
						<s:hidden name="clientId" id="clientId"></s:hidden>
						<div
							class="col-lg-12 col-md-12 col-xs-12 col-sm-12 topback2  hidden-print"
							...
							<div class="table-responsive">
								<table
								   ...
								   <tr>
						            ...
						            <s:if test="Isduty==1">
                                    <td><s:property value="Accepted_time"/></td>
                                     </s:if>
                                    <td>
						              <s:if test="Isduty==1">
									      Accepted
								  ...
								  <s:else>
<%-- 						           <a href="#" class="btn btn-primary" onclick="openSamll('confirmstatusUserProfile?id=<s:property value="id"/>')">Confirm</a>
 --%>                                  <input onclick='confirmstatus(<s:property value="id"/>)' type='button' value='Done ' class='btn btn-primary' >
                                  </s:else>
									</td>
