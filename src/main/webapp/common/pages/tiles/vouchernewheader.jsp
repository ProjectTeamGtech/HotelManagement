...
.animsition{margin-top: -12px!important;}
    ...
    display: flex;
    border-bottom: 2px solid #5fa2af;
...
<%LoginInfo loginInfo = LoginHelper.getLoginInfo(request); %>
  ...
  <div style="display: flex;width: 75%">
	  <span style="cursor:pointer;color:gray" onclick="openNav()">&#9776; </span>
	   <!-- <img src="dashboardicon/expensis.png" class="" > -->
	   <img src="manasmaindashboard/images/Accounts_Icon.svg" style="margin-top: 21px;">
	  <span> Accounts </span>
  </div>
  <div class='sideinfo'>
   <%-- <span  >Welcome</span>
  ...
  <div ></div>
   ...
   <!-- ====================================================
        ================= Application Content ===================
        ===================================================== -->
        <div id="wrap" class="animsition hidden">
            <!-- ===============================================
            ================= HEADER Content ===================
            ================================================ -->
            <section id="header">
                <header class="clearfix">
                    ...
                    <ul class="nav-left pull-left list-unstyled list-inline">
                       <!--  <li class="sidebar-collapse divided-right">
                        ...
                        <li class="divided-right">
                            <h4 style="color: #fff;line-height: 29px;font-size:18px;font-weight: bold;"> Vouchers  </h4>
                        </li>
                    </ul>
                    <!-- Left-side navigation end -->
                    <!-- Right-side navigation -->
                    <ul class="nav-right pull-right list-inline hidden-xs hidden">
