                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
										...
										<%-- 	<script>
											...
											<li class="dropdown">
                                            <i class="fa fa-bed" style="margin-left: 42px;"></i>
                                                <a href="#" title="IPD"> IPD</a>
                                                <ul>
                                            ...
                                            <li class="hidden">
                                                <a href="#" title="Expenses"><i class="fa fa-plane" style="margin-left: 42px;"></i> <span>Expenses</span></a>
                                                <ul>
											...
											<% if (loginInfo.isFullFinance()) {%>
													<li class="dropdown">
													<i class="fa fa-calculator" style="margin-left: 42px;"></i>
                                            ...
                                            <%if (loginInfo.isManageprisc()) {%>
												<li class="dropdown">
												<i class="fa fa-file-text-o" style="margin-left: 42px;"></i>
												<a href="#" title="Prescription"> Prescription</a>
                                                <ul>
                                                    <li>
											...
											<%if (loginInfo.isManageinvst()) {%>
												 ...
												 <li class="dropdown">
												 <i class="fa fa-flask" style="margin-left: 42px;"></i>
												 <a href="#" title="Investigation"> Investigation</a>
                                                <ul>
                                                    <li>
											...
											%>
											<li class="dropdown">
											<i class="fa fa-bar-chart-o" style="margin-left: 42px;"></i>
											...
											%>
                                            <li class="dropdown">
                                            <i class="fa fa-users" style="margin-left: 42px;"></i>
                                                <a href="#" title="Third Parties"> Third Parties</a>
                                                <ul>
                                            ...
                                            <li class="dropdown">
                                            <i class="fa fa-bar-chart-o" style="margin-left: 42px;"></i>
                                                <a href="#" title="Common Report">Reports</a>
                                                <ul>
                                                   	<li><a href="#" onclick="openPopup('paymentReportChargesRpt')"><i class="fa fa-caret-right"></i> Payment Report Big</a></li>
                                                 	<li><a href="#" onclick="openPopup('smallpaymentReportChargesRpt')"><i class="fa fa-caret-right"></i> Payment Report Small</a></li>
