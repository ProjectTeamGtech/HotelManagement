		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12"
					...
					<h4 style="font-size: 17px; font-weight: 600; color: white">Update Punchkarma</h4>
				</div>
...
<s:form action="updatePunchKarmaNoteDuty">
...
<s:hidden name="parentid" id="parentid"></s:hidden>
				...
				<div class="form-group">
					...
					title="Enter Ipd Template Text" theme="simple" placeholder="Enter Ipd Template Text" />
						</div>
