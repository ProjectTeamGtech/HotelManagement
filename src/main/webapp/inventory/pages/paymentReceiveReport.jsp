				...
				<%@ include file="/accounts/pages/letterhead.jsp"%>
				                           ...
				                           <div class="form-inline">
					                            ...
					                            <div class="form-group">
				                           		...
				                           		<div class="form-group" style="width:9%;">
												  	<s:textfield readonly="true" cssClass="form-control" id="fromdate" name="fromdate" placeholder="From Date" cssStyle="width:100%;"/>
												</div>
												<div class="form-group" style="width:9%;">
												  	<s:textfield readonly="true" cssClass="form-control" id="todate" name="todate" placeholder="To Date" cssStyle="width:100%;"/>
												</div>
										    ...
										    <div class="form-group" style="width: 15%">
										      <s:select name="billtype" id="billtype" list="#{'0':'Payment Mode','Cash':'Cash','Credit':'Credit','Cash':'Cash','Card':'Card','Cheque':'Cheque','NEFT/RTGS':'NEFT/RTGS','Estimate':'Estimate','Hospital':'Hospital','Online Payment':'Online Payment'}" cssClass="form-control chosen-select" />
										    </div>
										    <div class="form-group" style="width: 9%;">
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 0px;">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 hidden-lg hidden-sm hidden-md visible-print" style="padding: 0px;">
										<center><h3>Payment Received Report </h3> </center>	
									</div>
