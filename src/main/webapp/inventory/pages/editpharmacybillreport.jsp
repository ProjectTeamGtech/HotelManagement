...
<body>
								<div class="row details">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										...
										<h4>Pharmacy Edit Bill Report </h4>
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 0px;">
									 <s:form theme="simple" action="editpharmacybillreportProduct" >
										...
										<!-- <div class="col-md-6"> -->
				                           <div class="form-inline hidden-print">
												...
												<div class="form-group" style="width:14%;">
													<s:select list="locationListPharmacy" name="location" cssStyle="width:100%" cssClass="form-control chosen-select" listKey="id" listValue="name" headerKey="0" headerValue="Select Location" >
													</s:select>
												</div>
									...
									<table class="table table-bordered table-striped xlstable" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
					                                <thead>
					                                    <tr class="loc" >
					                                    	...
					                                    	<th style="width: 10%;">Abrivation</th>
					                                    	<th style="width: 5%;">Bill No</th>
					                                    	<th style="width: 10%;">Bill Date</th>
					                                    	<th style="width: 10%;">Location</th>
					                                    	<th style="width: 15%;">Product Name</th>
					                                        <th style="width: 6%;">Change Qty</th>
					                                        <th style="width: 10%;">Edit Userid</th>
					                                    	<th style="width: 11%;">Edit Date/Time</th>
					                                    </tr>
					                                </thead>
					                                <tbody>
