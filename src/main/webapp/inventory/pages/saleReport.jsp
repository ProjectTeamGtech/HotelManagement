<%-- <%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%> --%><!-- comented beacuse it gives error and below also line added-->
				...
				<%@ include file="/accounts/pages/letterhead.jsp"%>
				                           ...
				                           <div class="form-inline">
												...
												<div class="form-group" style="width: 15%;">
													<s:select name="billtype" id="paymode"  
															list="#{'':'Payment Mode','Card':'Card','Cash':'Cash','Credit':'Credit','NEFT':'NEFT','Cheque':'Cheque','Online Payment':'Online Payment'}"
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 0px;">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 hidden-lg hidden-sm hidden-md visible-print" style="padding: 0px;">
										<center><h3>Sale Report </h3> </center>	
									</div>
