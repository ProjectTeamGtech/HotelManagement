...
<body>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center hidden-lg hidden-md visible-print">
				<h3 class="text-uppercase" style="margin: 5px 0px 0px 0px;"><b>Bin Card Report</b></h3>
			</div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
		<table class="table table-responsive table-bordered" id="example">
			...
			<tbody>
			  ...
			  <%String bgcolr=""; %>
			   <s:if test="transtype=='Procurement'">
			   		<%bgcolr="lightgreen"; %>
			   </s:if>
			  
				<tr style="background: <%=bgcolr%>;">
					...
					<td class=""><s:property value="previous_qty" /></td>
					<td><s:property value="change_qty" /></td>
					<td class=""><s:property value="current_qty" /></td>
