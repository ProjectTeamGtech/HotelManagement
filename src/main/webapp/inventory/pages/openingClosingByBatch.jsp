									...
									<div class="col-lg-12 col-md-12 topback2 hidden-print">
										<!-- <div class="col-md-12"> -->
				                           <form class="form-inline" name="inventoryOpeningClosingBycatalogueProduct" method="post" id="myform" >
				                          		<div class="form-group">
					                           		<span class="text-uppercase"><b>Opening Closing By Batch Report</b> &nbsp; - &nbsp;</span>
					                           	</div>
				                          		<br>
												...
												<div class="form-group" style="width:15%;">
													<s:select list="warehouseList" id="location_filter" name="location_filter" listKey="id" listValue="name" headerKey="0" headerValue="Select Location" onchange="setProductofStoreOCR(this.value)" cssClass="form-control chosen-select"  cssStyle="width:0px !important"></s:select>
												</div>
												<div class="form-group" style="width:15%;" id="proddiv">
										     		<s:select list="prodnamelist" id="product_id" name="product_id" listKey="id" listValue="product_name" headerKey="0" headerValue="Select Product"  cssClass="form-control chosen-select"  cssStyle="width:0px !important"></s:select>
												</div>
				                       ...
				                       <!--  <div class="col-md-2 text-right" style="padding:0px;">
										...
										<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 hidden-lg hidden-sm hidden-md visible-print" style="padding: 0px;">
											<center><h3>Opening Closing By Batch Wise Report </h3> </center>	
										</div>
