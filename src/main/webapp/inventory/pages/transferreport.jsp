...
<%-- 		<s:select headerKey="0" headerValue="To location" cssClass="form-control chosen-select" list="locationlist" name="location_filter" listKey="id" listValue="name"/>
 --%>		
		<% if(loginInfo.getSuperadminid()==1 || loginInfo.getUserType()==2) {%>
		           <s:select headerKey="0" headerValue="To location" cssClass="form-control chosen-select" list="locationlist" name="name" listKey="id" listValue="name"/>
			
				<%}else{ %>
		<s:select  headerValue="To location" disabled="true" cssClass="form-control chosen-select" list="locationlist" name="name" listKey="id" listValue="name"/>
