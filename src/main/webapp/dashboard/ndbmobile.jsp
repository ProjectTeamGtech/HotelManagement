...
<body>
 <div class="calennw">
      ...
      <div id="calhead" class="col-sm-12 col-md-12 opdmainmargintop" style="padding-left:0px;padding-right:0px;padding-top: 30px">       
            ...
            <div class="col-lg-12 col-md-12 opddateleftmargin">
            	<table width="100%" cellpadding="0" cellspacing="0">
                   ...
                   <%-- <s:submit id="printcomdashboard" value=" Preview " onclick="getPrintData()" theme="simple" cssclass="btn btn-primary" style="margin-top: -1px; padding: 2px;"></s:submit> --%>      
                       	...
                       	<s:form action="getAllPrintDataNotAvailableSlot?action=dashboard" id="printdashboardfrm" method="post" 
              							onsubmit="return getPrintDataOfAll(this.target)" target="formtarget" cssStyle="padding-left: 114px" theme="">
                						...
                						<%-- <div  id="showmonthbtn" class="fbutton ">
            	 							<div style="margin-top: 2px;">
            	 								<span  class="">
              										...
              										<input onclick="showspecialitypopup()" type="button" id="" value=" Speciality" class="btn" style="background-color: #eee;border-color: #ccc;color: black;"/>
                								</span>
                							</div>
                						</div> --%>
                						...
                						<div  id="showmonthbtn" class="fbutton ">
            	 							<div style="margin-top: 2px;">
            	 								<span  class="">
              										...
              										<input onclick="getslot(0)" type="button" id="" value=" Available Slot" class="btn" style="background-color: #eee;border-color: #ccc;color: black;"/>
                								</span>
                							</div>
                						</div>
                						...
                						<div  id="showmonthbtn" class="fbutton">
            	 							<div style="margin-top: 2px;">
            	 								<span  class="">
              										...
              										<input onclick="showconfirmationpopup()" type="button" id="" value="Registartion Popup" class="btn" style="background-color: #eee;border-color: #ccc;color: black;"/>
                								</span>
                							</div>
                						 <div  id="showmonthbtn" class="fbutton hidden-xs hidden-sm">
            	 							<div style="margin-top: 2px;">
						...
						<div class="input-group col-lg-2 ">
									...
									<s:if test="%{#userList != 'null'}">
										...
										<s:select cssClass="form-control showToolTip chosen-select"
											id="diaryUsersss" name="diaryUser" list="userList" listKey="id"
											listValue="diaryUser" headerKey="0" theme="simple"
											headerValue="Select Doctor " onchange="hidelabe(this.value)" 
											/>
											<%}else{ %>
											<s:select cssClass="form-control showToolTip chosen-select"
											id="diaryUsersss" name="diaryUser" list="userList" listKey="id"
										...
										<div class="input-group col-lg-2 ">
                                          ...
                                          <s:textfield theme="simple"  name="commencing" cssClass="form-control calenderne"  aria-describedby="basic-addon1" id="commencing" onchange="getslot()"/>
                                      </div>
