...
<body>
 <div class="calennw">
      ...
      <div id="calhead" class="col-sm-12 col-md-12 opdmainmargintop" style="padding-left:0px;padding-right:0px;padding-top: 30px">       
            ...
            <div class="col-lg-10 col-md-10 opddateleftmargin <%=hideheader%>">
                       	...
                       	<s:form action="getAllPrintDataNotAvailableSlot?action=dashboard" id="printdashboardfrm" method="post" 
                						...
                						<div  id="showmonthbtn" class="fbutton hidden-xs hidden-sm">
            	 							<div style="margin-top: 2px;">
                								...
                								&nbsp;<i class="fa fa-ban fa-2x" aria-hidden="true" title="Block Slot" onclick="getslot()"></i>&nbsp;
                							</div>
                						</div>
