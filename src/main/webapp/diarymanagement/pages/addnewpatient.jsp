...
<input type="text" id="deptcamp" name="deptcamp" />
 <form action="<%=actionvalue%>" theme="simple" name="clientfrm" id="clientfrm" enctype="multipart/form-data">
 						...
 						<s:hidden name="physioipd" id="physioipd" value="0"></s:hidden>
 						<s:if test="isfromaddpatientlmh==1">
										...
										<div class="col-lg-12 col-md-12 hidden" style="margin-top: 15px;" >
											<label><%=loginfo.getPatientname_field() %> Image</label>
                                        		...
                                        		<div class="col-lg-12 col-md-12" style="padding: 0;margin-bottom: 5px;">
                                        			...
                                        			<!-- Third Column Start -->
                                        			<div class="col-lg-4 col-md-4" style="overflow-y:scroll;height: 350px;">
						                            	<div class="col-lg-12 col-md-12 ajpadzero" style="background-color: powderblue;">
						                        			<h4 >&nbsp;Payee Details</h4>
						                        		</div>
							                       		<div class="col-lg-12 col-md-12 ajpadzero" style="margin-top: 10px;">
							                   		...
							                   		<%if(!loginfo.isLmh()) {%>	
							                   			...
							                   			<div class="col-lg-12 col-md-12 ajpadzero" id="campareaId" style="display:none;">
							                   				...
							                   				<div id="camplocationdiv">
							                   				    <s:select cssClass="form-control showToolTip chosen"
																		data-toggle="tooltip" id="campArea" 
																		name="campArea" list="CamplocationList" listKey="Camp_location"
																		listValue="Camp_location" headerKey="0" theme="simple"
																		headerValue="Select Location"/><br>
																		<label  id = "campAreaError" class="text-danger"></label>
					       				                         </div>
					       				                      </div>
							                   			</div>
							                   			<!--@rahul reqirement this is for dept camp payer -->
							                   			<div class="col-lg-12 col-md-12 ajpadzero" id="campareaId1" style="display:none;">
							                   				<div class="col-lg-4 col-md-4">
								                            	<label>Camp Area</label><span class="text-danger reqd-info">*</span>   		         					
							                   				</div>
							                   				 <div class="col-lg-8 col-md-8" >
							                   				  <s:textfield name="deptcampArea" id="deptcampArea" placeholder="Enter Area" cssClass="form-control" cssStyle="border:1px solid;"></s:textfield>
							                   				 <label  id = "deptcampError" class="text-danger"></label>
							                   				  </div>
							                   			</div>
                 ...
                 <%if(loginfo.isMatrusevasang()){ %>	
                  	...
                  	<%} %>
                       		...
                       		<!-- Second Column End -->
                       		<!-- Third Column Start -->
                       		 <div class="col-lg-4 col-md-4" id="paymentdiv">
                       		 	<div class="col-lg-12 col-md-12 ajpadzero" style="background-color: powderblue;">
                        			<h4 >&nbsp;Payment Details 
                        			<%if(loginfo.isPhysio()) {%>
                        			<s:if test="isfromaddpatientlmh==1">
	...
	<div class="row">
		...
		<a href="addCompleteInfoRegistration"  class="btn btn-primary active" style="width: 100px">Reset</a>&emsp;&emsp;&emsp;
			<input type="submit" id="savebtn" value="Save" onclick="return validateAllDetails()" style="width: 100px" class="btn btn-success active">
		</div> 
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
     ...
     <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="savenewlocation()" style="margin-top: 20px;">Save</button>
     </div>
    </div>
...
<!-- End Loader  -->
  ...
  $(document).ready(function () {
      $('#typeName').change(function () {
    	 if ($('#typeName').val() != '68'){//@ rahul we are adding this beacuse for payer dept camp text box show in camp area
          if ($('#typeName').val() == '52' || document.getElementById("isCampArea").value==1) {
              $('#campareaId').show();
              $('#campareaId1').hide();
          }
              ...
              $('#campareaId').hide();
          }                                        //this if and else orignal code
    	 }else{//@ rahul we are adding this beacuse for payer dept camp text box show in camp area
    		 if ($('#typeName').val() == '68' && document.getElementById("isCampArea").value==1) {
    			 document.getElementById('deptcamp').value=='68' ;
                 $('#campareaId1').show();
                 $('#campareaId').hide();
             }
             else {
