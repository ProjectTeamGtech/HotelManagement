...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: #efefef;padding: 8px 0px 8px 0px;">
	...
	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			<input type="text" name="searchText" id="empsearchText" autofocus="autofocus" onchange="searchEmployee()"
				placeholder="Search by Empcode" class="form-control" style="width:100% !important; border: 1px solid;">
	...
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="text-align: left: ;">
		<button class="btn btn-primary" type="button"
					onclick="searchEmployee()">Search</button>&emsp;
<%-- 		<a href="#" class="btn btn-primary" id="addpatientbtn"	onclick="addPatient()">Add New <%=loginInfo2.getPatientname_field() %></a>
 --%>	</div>
</div>
<br />
