 ...
 <form action="<%=actionvalue%>" theme="simple" name="clientfrm" id="clientfrm" enctype="multipart/form-data">
                        ...
                        <input type="hidden" id="gpnameErrorlbl" name="gpnameErrorlbl" />
 						...
 						<s:hidden id="isCampArea" name="isCampArea"></s:hidden>
								...
								<div class="row">
								 ...
								 <%} %>	
									<div class="col-md-2 col-lg-2 col-xs-12 col-sm-12 text-left hidden" style="margin-top: 4px;margin-bottom: 2px;">
									...
									<s:if test="isfromaddpatientlmh==0">
										<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12 text-right hidden" style="margin-top: 6px;margin-bottom: 2px;">
									...
									<s:else>
										<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12 text-right hidden" style="margin-top: 10px;margin-bottom: 2px;">
											<input type="radio" id="regwopd" name="opdoption" value="regwopd" style="margin: 0px !important;" checked="checked" onchange="hidevaldiv(0)">
										...
										<%if (loginfo.isReport() == true) {
											%>
											<div class="bs-docs-example hidden">
											...
											<label><%=loginfo.getPatientname_field() %> Image</label>
                                        		...
                                        		<div class="col-lg-12 col-md-12" style="padding: 0;margin-bottom: 5px;">
                                        			...
                                        			<div class="col-lg-4 col-md-4">
	                                        			...
	                                        			<div class="col-lg-12 col-md-12 ajpadzero" id="campareaId" style=";">
							                   				<div class="col-lg-4 col-md-4">
								                            	<label>Client Type</label><span class="text-danger reqd-info">*</span>   		         					
							                   				</div>
							                   				 <div class="col-lg-8 col-md-8" >
							                   				   <span><a href="#" data-toggle="modal" data-target="#addlocationpopup">+Add Location</a></span>
							                   				<div id="clienttypediv">
							                   				    <s:select cssClass="form-control showToolTip chosen"
																		data-toggle="tooltip" id="clientType" 
																		name="clientType" list="ClientTypeList" listKey="clientType"
																		listValue="clientType" headerKey="0" theme="simple"
																		headerValue="Select Client Type"/><br>
																		<label  id = "clientTypeError" class="text-danger"></label>
					       				                         </div>
					       				                      </div>
							                   			</div>
                                        			</div>
	...
	<div class="row">
		...
		<!-- <input type="button" value="OPD Preview" class="btn btn-info active" onclick="openPopup('getAllPrintDataNotAvailableSlot?action=dashboard')">&emsp;&emsp; -->
		 	<input type="button" value="OPD Preview" class="btn btn-info active hidden" onclick="openPopup('lmhopdpreviewFinder')">&emsp;&emsp;
			<input type="button" value="Department OPD" class="btn btn-info active hidden" onclick="openPopup('departmentopdFinder')">&emsp;&emsp;
			<input type="button" value="Patient List" class="btn btn-info active hidden" onclick="openPopup('manageClient')">&emsp;&emsp;
		<s:if test="isfromaddpatientlmh!=0">
...
<!-- 		<a href="addCompleteInfoRegistration"  class="btn btn-primary active" style="width: 100px">Reset</a>&emsp;&emsp;&emsp;
 ...
 <div id="addlocationpopup" class="modal fade" role="dialog" style="z-index: 11000">
    ...
    <div class="modal-content">
      <div class="modal-header">
       <button type="button" class="close" data-dismiss="modal" style="margin-top: -7px !important">
        ...
        <h4 class="modal-title">Add Client Type</h4>
      </div>
      ...
      <div class="modal-body">
        <div class="">
        	<div class="col-lg-12 col-xs-12 col-md-12" style="padding-top: 9px;">
        			<div class="form-group">
        			<label>Client Type</label><label class="text-danger">*</label>
					<s:textfield id="addclient"
						cssClass="showToolTip form-control" data-toggle="tooltip"
						title="Enter Client Type" placeholder="Enter Client Type"
     ...
     <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="saveclientType()" style="margin-top: 20px;">Save</button>
     </div>
    </div>
