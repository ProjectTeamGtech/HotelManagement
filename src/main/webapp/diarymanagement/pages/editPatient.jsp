							...
							<div class="">
								...
								<div class="row">
									...
									<s:form action="updateClient"  theme="simple" enctype="multipart/form-data">
										...
										<s:hidden id = "fromprodasboard" name = "fromprodasboard"></s:hidden>
	...
	<div class="col-lg-12 col-md-12" style="margin-top: 15px;" >
							...
							<div class="col-lg-12 col-md-12">
											...
											<%}else{ %>
												...
												<s:textfield  id="fathername" name="fathername" title="Enter Father Name"  theme="simple" cssClass="form-control showToolTip"
												 data-toggle="tooltip" placeholder="Enter Father Name"/>
												 <%} %>
											</div>
											...
											<div class="col-lg-3 col-md-3">
												...
												<s:textfield  id="mothername" name="mothername" title="Mother Name"  theme="simple" cssClass="form-control showToolTip"
											...
											<div class="col-lg-1 col-md-1" id = ""><br>
						...
						<div class="row">	
							...
							<div class="col-lg-4 col-md-4">
							 ...
							 <div class="col-lg-4 col-md-4">
								...
								<s:textfield id="alternate_mobno" name="alternate_mobno" title="Enter Alternate No"
									cssClass="form-control showToolTip" data-toggle="tooltip"
								list="pdl_mobNo" onkeyup="getpatientfordatalist(this.value,'pdl_mobNo','mobno')"
									placeholder="Enter Alternate No."  maxlength="10"/>	
						...
						<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 text-right">
									...
									<s:if test="fromprodasboard!=1">
										<a href="manageClient" class="btn btn-primary">Back to List Page</a>
									</s:if>
