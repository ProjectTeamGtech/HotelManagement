...
<s:form action="updateDuty" id="master_form" theme="simple">
<div class="row">
			...
			<div class="panel-body">
			 ...
			 <label>Patient Name</label><label class="text-danger">*</label>
				...
				<s:textfield id="city" name="city"
					...
					<input type="radio" name="pickdrop" id="pickdrop" value="hospital" checked="checked" />  
					<label>Drop to Hospital</label>&nbsp;&nbsp;&nbsp;&nbsp;
				    <input type="radio" name="pickdrop" id="pickdrop" value="home" checked="checked"/>  
