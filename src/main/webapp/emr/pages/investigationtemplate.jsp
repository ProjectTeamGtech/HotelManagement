...
<script>
 bkLib.onDomLoaded(function() {
	        	 ...
	        	 <%--  nicEditors.findEditor('template_text').setContent("<%=find%>"); --%>
...
<s:form action="savefindInvestigation" id="master_form" theme="simple">
<div class="row">
			...
			<div class="col-lg-12 col-xs-12 col-sm-12" style="padding: 0px;">
						...
						<div class="form-group">
							<label>Select Investigation Section <span class="text-danger">*</span></label>
							 <s:select list="invsSectionList" listKey="id" listValue="name" name="invs_section_id" title="select investigation section"
									onchange='getinvstemplate1(this.value)'	cssClass="form-control chosen-select"  > </s:select> 
						</div>
					</div>
				...
				<div class="form-group">
					...
					title="Enter Ipd Template Text" placeholder="Enter Investigation Template Text" ></s:textarea>
					    ...
					    <s:hidden id="selecteid" name="selectedid"/>
						<s:hidden id="fromdate" name="fromdate"/>	
						<s:hidden id="todate" name="todate"/>		
						 <s:hidden name="approved" id="approved"></s:hidden>
