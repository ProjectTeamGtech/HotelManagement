...
<s:form action="physioipdFinder" id="deptfrm" theme="simple">
	...
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 topback2  hidden-print">
		...
		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 topback2 hidden-print">
			<div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
				<input id="myInput" type="text" placeholder="Search Patient" name="searchText" onkeyup="myFunction()" class="form-control">&emsp;
			</div>	
			<div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
				<a href="#" class="btn btn-primary" onclick="openBlankPopup('Patientdata')">Add Clinical Patient</a>
				<a href="#"  onclick="opencPopup('addnewIpdPatientRegistration')" class="btn btn-primary">Physio Registration</a>
				<a href="#"  onclick="openBlankPopup('ipdsmallpaymentReportChargesRpt')" class="btn btn-primary">Payment Report Small</a>
<!-- 				<a style="margin-bottom: 5px;" href="#" onclick="openopdpreviewwindow()"id="printcomdashboard" class="btn btn-primary">Preview</a>
 -->				<a href="#"  onclick="openBlankPopup('getAllPrintDataforipdNotAvailableSlot?action=dashboard')" class="btn btn-primary">Preview</a>
				<input type="button" value="Physio IPD Report" class="btn btn-info active" onclick="openPopup('physioipdpreviewFinder')">
				
				<!-- <input type="button" value="Daily OPD" class="btn btn-info active" onclick="openPopup('dailyregistrationrptFinder')"> -->
				<input type="button" value="Session Report" class="btn btn-info active" onclick="openPopup('IpdsittingandfollouprptChargesRpt')">
			...
			<div class="row">
				<div class="col-lg-12">
						...
						<table class="table table-hover table-condensed table-bordered">
							<thead style="text-align: center;">
								...
								<tr>
									...
									<td>Contact No</td>
									<%if(!loginInfo.isAmravati()){ %>
									<td hidden >Patient Category</td>
									<%} %>
									<td hidden>Camp Area</td>
									<td hidden>Enrollment No</td>
									<td>Allotted Department</td>
									<td hidden>Referred From Dept</td>
					...
					<s:iterator value="departmentOPDList">
						<s:if test="Totalsetting!=0">
						  <s:if test="Totalsetting>Ipdsetting">
						...
						<tr style="background-color:#f5c286; ">
								...
								<%-- 	<td><s:property value="addedBy"/></td> --%>
									...
									<td hidden="true"><s:property value="invoiceid"/></td>
									<td>
									...
									<%if(!loginInfo.isAmravati()) {%>
									<td hidden><s:property value="patientcategory" /> </td>
									<%} %>
									<td hidden><s:property value="campArea" /></td>
									<td hidden><s:property value="enrollcode" /></td>
									<td><s:property value="departmentname"/></td>
									<td hidden><s:property value="referredfromdept"/></td>
 								  ...
 								  <%--   <td><a href="#" onclick="showsitting(<s:property value="id"/>,<s:property value="clientId"/>)">Add Sitting</a></td>
									...
									<%if(!loginInfo.isMatrusevasang()){ %>
									       <td><s:property value="Ipdsetting"/>/<s:property value="Totalsetting"/></td>
							               <td style="vertical-align: middle;">
												<input onclick="showsittingforPatient1(<s:property value="id"/>,<s:property value="clientId"/>,'<s:property value="clientName"/>',<s:property value="dept"/>,<s:property value="totalsetting"/>,<s:property value="ipdsetting"/>)" type='button' value='Add Session' class='btn btn-primary' >
											</td>
									...
									<td style="vertical-align: middle;">
										        ...
										        <input onclick="showipdsitting(<s:property value="clientId"/>)" type='button' value='View Session' class='btn btn-primary' >	
								...
								<td hidden style="vertical-align: middle;">
										<select name="doctid"  id="doctid" class="form-control" onchange="showdoctpopup(this.value,<s:property value="id"/>,<s:property value="clientId"/>)" >
									...
									<td style="vertical-align: middle;"><a href="#" onclick="openPopup('debit1Additional?clientId=<s:property value="clientId"/>&id=<s:property value="id"/>')"><i style="vertical-align: sub;" class="fa fa-plus"></i></a></td>
									<td style="vertical-align: middle;"><a href="#" onclick="openPopup('Statement?clientId=<s:property value="clientId"/>')"><i style="vertical-align: sub;" class="fa fa-eye"></i></a></td>
								    ...
								    <td style="vertical-align: middle;"><s:select list="userList" theme="simple" listKey="id" listValue="diaryUser" class="form-control" name="doctid" id="doctid"/></td>
	  ...
	  <div class="modal-dialog modal-md" role="document">
		  <div class="modal-content">
			  <div class="modal-header">
				...
				<h3 class="modal-title" id="myModalLabel">Session</h3>
...
<%-- 				   <span style="padding-left: 660px;"><a href="#" class="btn btn-warning hidden-print" onclick="printDiv('newdiv')" style="margin-top: 15px;">print</a></span> 
 --%>			<div class="table-responsive" > 
		      ...
		      <thead>
				    <tr style="background-color: meadowgreen;">  
						...
						<th hidden class="text-center">Procedure MasterName</th>
						<th hidden class="text-center">Procedure Name</th>
						<th class="text-center">Session No</th>
						<%if(loginInfo.isPhysio_ipd()){ %>
					    <th class="text-center">Diagnosis</th>	
					    <%} %>
					    <th class="text-center">Bed/Ward Name</th>
  ...
  <div class="modal-body">
      ...
      <%-- 	 <%if(loginInfo.isPhysio()){ %>
      		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
	      			...
	      			<s:select list="disciplineList" name='Discipline' id='dept' listKey="id"  listValue="discipline" headerKey="" headerValue="All Department" onchange="setDepartmentsitting(this.value)" cssClass="form-control chosen-select" ></s:select>
      ...
      <!-- 	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"> -->
          <%if(!loginInfo.isBalgopal()) {%>
            ...
            <%--  <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
      		...
      		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 <%=scolomn %>">        			
          ...
          <!-- </div> -->    
      	 ...
      	 <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
      			<div class="form-group">
      		     ...
      		     <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">        			
                    <div class="form-group" id="sitting_num" >
        				 <label>Bed/ward Name</label><label class="text-danger">*</label>
				              <input type="text" id="bed_ward" name="bed_ward"
				                Class="showToolTip form-control" data-toggle="tooltip"
					            title="Enter Bed/Ward Name" placeholder="Enter Bed/Ward Name"/>
        	    </div>
        	 </div>
        	 ...
        	 <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
      			<div class="form-group" id="hosp">
	      			...
	      			<s:select list="Physioipdhospitallist" name='Hosp_name' id='Hosp_name' listKey="id"  listValue="Hosp_name" headerKey="Select Hospital"   cssClass="form-control chosen-select" ></s:select>
      			</div>
      		</div>
     ...
     <div class="modal-footer">
     	<button type="button" class="btn btn-primary"
							onclick="showipdsittingfollowuplist(<%=loginInfo.isPhysio_ipd()%>)" style="margin-top: 15px;">Save</button>
       </div>
     </div>
   </div>
</div>  
