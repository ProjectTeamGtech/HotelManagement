           ...
           <div class="header-area">
                    ...
                    <div class="col-md-4 col-sm-4 clearfix">
                        <ul class="notification-area pull-right">
                            ...
                            <%if(loginInfo.getLoginType().equals("mob")){
                            	...
                            	<div class="dropdown show <%=loghide %>" style="margin-left: 0px;">
			...
			<%} %>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding-bottom: 20px;">
                                <!-- <div class="col-lg-11"> -->
                                  <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 <%=hidemobileuser %>">
                                 ...
                                 <%if(loginInfo.isLmh()){ %>
                                  ...
                                  <div class="col-lg-5 col-md-5 col-xs-12 col-sm-12" style="text-align: right;">
                                  <%if(!loginInfo.isLmh()){ %>
	                                <label style=";font-size: 15px;font-weight: 700;padding-left: 120px;">Total Incomplete Appointment :</label><label style="font-size: 15px;font-weight: 700;" id="undoneappt"></label>
	                                <%} %>
	                               </div> 
                                 </div>
                                ...
                                <table class="table-responsive" id="" border="1" style="width: 101%;font-family: 'Open Sans', sans-serif;">
...
<!--pure seva client details popup  -->
		...
		<div class="modal fade" id="puresevaclientdetailsdiv" tabindex="-1"
			...
			<div class="modal-dialog modal-xl" style="width: 72%">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-9">
								<s:select id="title123" name="title"  list="initialList" title="Select" theme="simple" onchange="setGender123(this.value)" cssClass="form-control" headerValue="Select" headerKey="0" cssStyle="width:100%;"/>
							</div>
						</div><br>
						<div class="col-lg-12">
							<div class="col-lg-3">
