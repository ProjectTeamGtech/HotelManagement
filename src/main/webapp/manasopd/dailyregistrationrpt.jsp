		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
					...
					<h4 style="font-size: 17px; font-weight: 600; color: white">Daily OPD
						</h4>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				<div>
					...
					<input type="hidden" id="invoicee" name="invoicee" /> <input
						...
						id='setp'>
					<s:form action="dailyregistrationrptFinder" id="deptfrm" theme="simple">
		...
		<s:select id="type"  name="type" list="thirdPartyTypeList" listKey="id" listValue="type" headerValue="Select Payer Type" 
			headerKey="0"  cssClass="form-control showToolTip chosen" data-toggle="tooltip" onchange="setTPName(this.value)" />
							...
							<div class="col-lg-2 col-md-2 col-xs-12 col-sm-12">
								...
								<s:select list="#{'Red':'Red','Yellow':'Yellow','Blue':'Blue','Pink':'Pink','black':'black','Green':'Green'}" id="patien"
									headerKey="" headerValue="Select Patient Type"
									name="patienttype" onchange="addTocoloursave(this.value)"
									cssClass="form-control showToolTip chosen-select"></s:select>
							</div>
							<%
							  } 
					...
					<br />
	<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 topback2 hidden">
									...
									<thead style="text-align: center;">
										...
										<tr>
											...
											<td style="width: 2%;" class="hidden-print">
                                    	     <input type="checkbox" id="selectalliventorystockid" onclick="selectAllCheckBoxOfDailyopd(this)"   />
                                            </td>
                                            <%
							                  } 
							                %>
...
<%-- <s:form action="dailyregistrationrptFinder" name="paginationForm"
...
<div class="col-lg-12 col-md-12 hidden-print hidden"
			style="margin-top: 15px;">
			<div class="col-lg-4 col-md-4 text-left" style="padding: 0px;">
				Total:<label class="text-info"><s:property
						value="FinalTotalPatientCount" /></label>
			</div>
			<%-- <jsp:include page="/common/pages/pagination.jsp"></jsp:include> --%>
		</div>
