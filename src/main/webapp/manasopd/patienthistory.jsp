		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
					...
					<h4 style="font-size: 17px; font-weight: 600; color: white">Patient History</h4>
				</div>
			</div>
		</div>
		<div class="row ">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				<div>
					...
					<s:form action="patienthistoryFinder" id="deptfrm" theme="simple">
						<div
							...
							<div class="table-responsive">
								<table
									...
									<tbody style="text-align: center;" id="newopdbodyid">
										...
										<s:iterator value="Patienthistorylist">
