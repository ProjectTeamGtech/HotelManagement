...
<div class="reportprint">
	...
	<div class="">
		...
		<div class="row ">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				<div>
					<s:form action="ipdfakeConsultreportCommonnew?IpdpatientType=0" id="deptfrm" theme="simple">
				           ...
				           <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
							 ...
							 <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
					              <label>Admitted By</label>
				                        <s:select cssClass="form-control  chosen-select" id="Userid" name="Userid" list="AdmittedbyuserList" listKey="Userid"
					                     listValue="Userid" headerKey="" theme="simple" headerValue="Select User"/>
			                   </div>
							...
							<div class="col-lg-2 col-md-2">
		                        <label>Depsrtment List</label>
		                             <s:select list="Ipdconsultdeptlist" name='Disciplineid' listKey="id" listValue="Disciplineid" headerKey="" headerValue="Department List" cssClass="form-control chosen-select"></s:select>
		                   </div> 
		...
		<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 ">
						<table class="tablebord table-hover table-condensed table-bordered" style="border: black 1px solid; margin-top:2%;margin-bottom: 2%;">
							<thead>
								<tr>
									<td>Department</td>
									<td>Male</td>
							...
							<tbody>
								 <s:iterator value="ipdgendercountlist">
								...
								<table
									...
									<thead style="text-align: center;">
										...
										<tr>
											...
											<%if(loginfo.isBams1() || loginfo.isMbbs()){ %>
											<td>Print</td>
											 <%} %> 
										</tr>
									...
									<tbody style="text-align: center;" >
										...
										<s:else>
											...
											<td><a href="#" style="cursor: pointer;" onclick="openPopup('printConsulatationFormCommonnew?clientId=<s:property value="Clientid"/>&apmtId=<s:property value="Opdid"/>')"><s:property value="Opdsequence"/></a></td>
									        <td  style="vertical-align: middle;"><a href="#" onclick="fakepopup('<s:property value="Abrivationid"/>','<s:property value="Clientid"/>','<s:property value="clientname"/>')"><s:property value="clientname" /></a></td>
											...
											<td><s:property value="department" /></td>
											<td><s:property value="wardname" />/<s:property value="bedname"/></td>
										...
										<s:if test="ischeck==0 ">
 										...
 										<%if(loginfo.isBams1() || loginfo.isMbbs()){ %>
 										<td><a href="#"  onclick="showdischargeprintpage('<s:property value="Clientid"/>')" title="Print Discharge Form"><i class="fa fa-print" aria-hidden="true"></i></a>
 										</td><%} %>
...
<%-- 											<td><input onclick="showsittingforPatient(<s:property value="id"/>)"><s:property value="DischargeDate" /></td>
 ...
 <div class="modal-content" style="height: 216px;width: 419px;margin-left: 29%">
   ...
   <span id="ipdcount" hidden="true"></span>
  <%--  <span class="hidden"  id="patient_nm"></span> --%>
    ...
    <div class="modal-content">
      ...
      <%String heightDyn="268px"; %>
       ...
       <div class="col-lg-12 borderdesing">
                                              <!-- opencPopup('calSlotAvailable?actionType=newopd&doctor=1') -->
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-xs-2 col-md-2 panthumb">
                                                     <div class="thumbnail">
                                                        ...
                                                        <img src="manasmaindashboard/images/My opd_icon.svg" alt="Email" style="width: 40px;">  
                                                         <div class="caption">
                                                              <p class="textclinet">Opd</p>
                                                          </div>
                                                         </a>
                                                         <div style="margin-left: 40%; color: red;">
                                                         <span style="centre" id="opdcount"></span>
                                                         </div>
                                                      </div>
                                                  ...
                                                  <div class="col-xs-2 col-md-2 panthumb">
                                                   <div class="thumbnail">
                                                      	<a href="#"  onclick="openotddash()">
                                                        <img src="manasmaindashboard/images/Pharmacy_Icon.svg" alt="raise_credit" style="width: 45px;">  
                                                         <div class="caption">
                                                              <p class="textclinet">OT</p>
                                                          </div>
                                                         </a>
                                                         <div style="margin-left: 40%; color: red;">
                                                         <span style="centre" id="otcount"></span>
                                                         </div>
                                                      </div>
                                                  </div>
                                                  
                                                  <div class="col-xs-2 col-md-2 panthumb" style="padding-top: 5%;">
                                                   <div class="thumbnail">
                                                      	<a href="#"  onclick="opendischargedash()">
                                                        <img src="manasmaindashboard/images/Pharmacy_Icon.svg" alt="raise_credit" style="width: 45px;">  
                                                         <div class="caption">
               ...
               <input type="button" value="delete" style="margin-top: 5%;margin-left: 44%" class="btn btn-info active" onclick="delte()">
