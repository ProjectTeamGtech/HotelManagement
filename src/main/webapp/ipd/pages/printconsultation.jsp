...
%>
	...
	<div class="letterheadhgt" >
		<div id="newpost"
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
				...
				<%@ include file="/accounts/pages/letterheadsimpli.jsp"%>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-lg-12 col-xs-12 col-md-12">
			...
			<hr class="new4" style=" margin: 0; padding: 0;">
		</div>
		<div class="col-lg-12 col-xs-12 col-md-12" style="padding: 5px; background-color: rgba(91, 192, 222, 0.16);">
            <div class="col-lg-7 col-md-7 col-xs-6 col-sm-6 " style="padding-right:0px;">
				<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>Patient Name</b></label><span>: <s:property value="client"/> </span>   
				</div>
				
				<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>UHID</b></label><span>: <s:property value="abrivationid"/> </span>
				</div>
				
				<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>Address</b></label><span>: <s:property value="address"/> </span>
				</div>
				
				<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>Contact No</b></label><span>: <s:property value="Contact"/> </span>
				</div>
				
				<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>OpdId</b></label><span>: <s:property value="opdid" />
					<%
				...
				<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>Age/Sex</b></label><span>: <s:property value="agegender" /></span>
				</div>
				
			
			</div>
			
		<div class="col-lg-5 col-md-5 col-xs-6 col-sm-6" style="padding-right:25px;">	
			<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>Primary Consultant</b></label><span>: <s:property value="doctor_name"/>(<s:property value="discipline" />)</span>
			
					<label for="inputEmail3" class="control-label"><b>Payee</b></label><span>: <s:property value="whopay"/></span>
			
					<label for="inputEmail3" class="control-label"><%if(!DateTimeUtils.isNull(ipdForm.getPulse()).equals("")){ %>
					<b>Pulse</b></label><span>: <s:property value="pulse"/> &nbsp;&nbsp;min</span><%} %> 
					<%if(!DateTimeUtils.isNull(ipdForm.getSys_bp()).equals("")){%>
					                 <span> | </span> <label for="inputEmail3" class="control-label"><b>bp</b></label><span>: <s:property value="sys_bp" />&nbsp;&nbsp;mmHg</span>
					                 <%} %>
					                 <%if(!DateTimeUtils.isNull(ipdForm.getSpo()).equals("")){%>
					                   <span>  | </span> <label for="inputEmail3" class="control-label"><b>SPO2</b></label><span>: <s:property value="spo" />%</span>
					                 <%} %>
					                 <%if(!DateTimeUtils.isNull(ipdForm.getTemp()).equals("")){%>
					                   <span> | </span> <label for="inputEmail3" class="control-label"><b>TEMP</b></label><span>: <s:property value="temp" />&nbsp;&nbsp;°F</span>
					                   <%} %>
					                 <%if(!DateTimeUtils.isNull(ipdForm.getSugarFasting()).equals("")){%>
					                   <span> | </span> <label for="inputEmail3" class="control-label"><b>SUGAR FASTING</b></label><span>: <s:property value="sugarFasting" />&nbsp;&nbsp;mm.dl</span>
					                 <%} %>
					                 <%if(!DateTimeUtils.isNull(ipdForm.getHeight()).equals("")){%>
					                   <span>  | </span> <label for="inputEmail3" class="control-label"><b>HEIGHT</b></label><span>: <s:property value="height" />&nbsp;&nbsp;cm</span>
					                 <%} %>
					                 <%if(!DateTimeUtils.isNull(ipdForm.getBmi()).equals("")){%>
					                   <span>   | </span> <label for="inputEmail3" class="control-label"><b>BMI</b></label><span>: <s:property value="bmi" />&nbsp;&nbsp; kg/m2</span>
					                 <%} %>
					                 <%if(!DateTimeUtils.isNull(ipdForm.getBmi()).equals("")){%>
					                   <span>   | </span> <label for="inputEmail3" class="control-label"><b>R/R</b></label><span>: <s:property value="respiratory_rate" />&nbsp;&nbsp;bpm</span>
					                 <%} %>
					                 <%if(!DateTimeUtils.isNull(ipdForm.getAllergynotes()).equals("NO")){%>
					                    <span>   | </span> <label for="inputEmail3" class="control-label"><b>ALLERGY</b></label><span>: <s:property value="allergynotes" /></span>
					                 <%} %>
			 </div>  
			 
			<%--  <%if(!DateTimeUtils.isNull(ipdForm.getPulse()).equals("")){ %>
					<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label">pulse</label><span>: <s:property value="pulse"/></span>
				</div>
				<%} %> --%>
				
				<div class="form-group" style="margin-bottom: 0px;">
					<label for="inputEmail3" class="control-label"><b>Consultatation Date</b></label><span>: <s:property value="Datetime"/> </span>
				</div>
		</div>
  </div>
	...
	<%-- <div class="col-lg-12 col-xs-12 col-md-12" style="padding: 0px; background-color: rgba(91, 192, 222, 0.16);">
		...
		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 settopad">
			...
			<div class hidden="col-lg-12 col-xs-12 col-md-12 textprime" style="margin-bottom: 5px;">
				<h5>Vitals</h5>
			</div>
			<div class hidden="col-lg-12 col-xs-12 col-md-12 col-sm-12" style="margin-bottom: 15px;">
				<%if(!DateTimeUtils.isNull(ipdForm.getPulse()).equals("")){ %>
			...
			<%if(!DateTimeUtils.isNull(ipdForm.getExamination()).equals("")){ %>
				<div class="col-lg-12 col-xs-12 col-md-12" style="margin-bottom: 0px;">
					<h4><b>HISTORY & EXAMINATION</b></h4>
					<hr class="new4" style=" margin: 0; padding: 0;">
				</div>
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin-bottom: -7px;">
			...
			<%if(ipdConditionids.size()>0){ %>
				<div class hidden="col-lg-12 col-xs-12 col-md-12 textprime">
					<h5>DIAGNOSIS</h5>
				</div>
			...
			<%if(!DateTimeUtils.isNull(ipdForm.getInvestigation()).equals("")){ %>
				<div class="col-lg-12 col-xs-12 col-md-12 " style="margin-bottom: -27px;">
					<h4><b>TREATMENT </b></h4>
					<hr class="new4" style=" margin: 0; padding: 0;">
				</div>
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
			...
			<div class="">
				...
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
						...
						<div class="form-group">
							<table class="table" id="priscTable">
								<thead>
									<tr class="headings">
									...
									<%for(Priscription priscription:dischargePriscList){ %>
										<tr>
											...
											<td class="uppercaseirf medname">
												<%=priscription.getMdicinenametxt() %>(<%=priscription.getStrength() %>)
											</td>
											<td>
												<%if(!DateTimeUtils.numberCheck(priscription.getPriscdose()).equals("0")){ %>
													<%=priscription.getRegional() %>
				...
				<%if(!DateTimeUtils.isNull(ipdForm.getDiscadvnotes()).equals("")){ %>
					<div class="">
						<div class="col-lg-12 col-xs-12 col-md-12 " style="margin-bottom: 0px;">
							<h4><b>
								ADVICE/FOLLOW UP</b>
							</h4><hr class="new4" style=" margin: 0; padding: 0;">
						</div>
