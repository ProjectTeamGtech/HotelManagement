...
<%@page import="com.apm.Ambulance.eu.entity.Duty"%>
<%@page import="com.apm.Emr.eu.entity.Investigation"%>
<%@page import="com.apm.Ipd.eu.entity.Bams"%>
...
<body>
				...
				<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 text-left"
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadleft">
						...
						<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
							<label>:</label>&nbsp;&nbsp; <span style=""><s:property
									value="regno" /></span>
						</div>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadleft">
						<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5 ">
							<label for="inputEmail3" class="control-label">Patient
								Name</label>
						</div>
						<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
							<label>:</label>&nbsp;&nbsp; <span style=""><s:property
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadleft">
						<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5 ">
							<label for="inputEmail3" class="control-label">Age /
								Gender</label>
						</div>
						<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
							<label>:</label>&nbsp;&nbsp; <span style=""><s:property
					...
					<s:if test="mlcno!=''">
						<div
							class="col-lg-12 col-md-12 col-xs-12 col-sm-12 <%=kunalhide%>">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
								<div class="form-group marbot3"
									style="margin-bottom: 0px !important;">
							...
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
								<div class="form-group marbot3"
									style="margin-bottom: 0px !important;">
									<span><b>:</b> <s:property value="mlcno" /></span>
								</div>
							</div>
						</div>
					</s:if>
				...
				<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 text-left"
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadright">
							<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5 ">
								<label for="inputEmail3" class="control-label"><s:if
										test="daycare">DayCare  NO</s:if>
									<s:else>IPD NO</s:else></label>
							</div>
							<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
 ...
 %> <s:property value="newipdabbr" /> <%
                     ...
                     <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadright">
							<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5 ">
								<label for="inputEmail3" class="control-label">Opd No</label>
							</div>
							<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
								<label>:</label>&nbsp;&nbsp; <span style=""><s:property
										value="Opd_abbrivation_id" /></span>
							</div>
						</div>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadright">
							...
							<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
								<label>:</label>&nbsp;&nbsp; <span style=""><s:if
										test="dischrgeOutcomes==''"> N/A</s:if> <s:else>
						...
						<s:if test="dischargeStatusId!=4">
							<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadright">
								...
								<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
									<label>:</label>&nbsp;&nbsp; <span style="" class=""><s:if
											test="dischargeStatus==''"> N/A</s:if> <s:else>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 divpadright">
							...
							<div class="col-lg-7 col-md-7 col-xs-7 col-sm-7">
								<label>:</label>&nbsp;&nbsp; <span style=""> <s:if
										test="dischargedate==''">N/A</s:if> <s:else>
						...
						<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 text-left"
							...
							<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
									<div class="form-group marbot3"
										style="margin-bottom: 0px !important;">
										<b id="ptname" for="inputEmail3"
											class="control-label newdcard">Patient Name</b>
									</div>
								</div>
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
									<div class="form-group marbot3"
										...
										<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
												<div class="form-group marbot3"
													style="margin-bottom: 0px !important;">
													<b id="ptname" for="inputEmail3"
														class="control-label newdcard">Relative Name</b>
												</div>
											</div>
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
												<div class="form-group marbot3"
													style="margin-bottom: 0px !important;">
													<span><b>:</b> <s:property value="relativename" />
													</span>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
										<s:if test="fathername!=''">
											<div class="form-group marbot3"
												style="margin-bottom: 0px !important;">
												<b for="inputEmail3" class="control-label"
													style="white-space: nowrap;">Father Name</b>
											</div>
										</s:if>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
										<s:if test="mothername!=''">
											<div class="form-group marbot3"
												style="margin-bottom: 0px !important;">
												<b for="inputEmail3" class="control-label"
													style="white-space: nowrap;">Mother Name</b>
											</div>
										</s:if>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<b for="inputEmail3" class="control-label"
												style="white-space: nowrap;"> MLC Consultant</b>
										</div>
									</div>
									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<span><b>:</b> <s:property value="mlcrefdoctor" /></span>
										</div>
 ...
 --%>
 								...
 								if (!DateTimeUtils.isNull(ipd.getDepartment()).equals("0")) {
 							%> (<%=ipd.getDepartment()%>) <%
 								}
 							%> <s:if test="useregno!=null">| Reg No:<s:property
													value="useregno" />
											</s:if><br> <%--  <s:property value="doctor_phone"/> --%></span>
					 ...
					 --%>
							...
							<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
									<div class="form-group marbot3"
										style="margin-bottom: 0px !important;">
										<b for="inputEmail3" class="control-label"> Opd No</b>
									</div>
								</div>
 ...
 --%>
										...
										<span><b></b> <s:property value="Opd_abbrivation_id" /> 
							...
							<s:if test="secndryconsult!=''">
								<div
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<b for="inputEmail3" class="control-label"> Secondary
												Consultant</b>
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
							...
							%>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<b for="inputEmail3" class="control-label newdcard1">
												Birth Weight</b>
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
							...
							%>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<b for="inputEmail3" class="control-label newdcard1">Gest
												Age</b>
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
							...
							<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right">
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<b for="inputEmail3" class="control-label"><s:if
													test="daycare">DayCare  NO</s:if>
												<s:else>IPD NO</s:else></b>
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left"
										style="padding: 0px;">
 ...
 <s:property value="Mbbsseqno" /></span>
											<%
										} else {
									%>
											<s:property value="ipdseqno" />
						...
						%>
								...
								<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left"
										...
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<s:if test="admissiondate!=''">
												<span><b>:</b> <s:property value="admissiondate" />
												</span>
											</s:if>
										</div>
									</div>
							...
							%>
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
											<div class="form-group marbot3"
												style="margin-bottom: 0px !important; margin-left: -10px;">
												<span><b>:&nbsp;&nbsp;</b><%=ipd.getHeadcircumference()%>
													cm</span>
											</div>
										</div>
										<%
							...
							%>
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-left">
											<div class="form-group marbot3"
												style="margin-bottom: 0px !important; margin-left: -10px;">
												<span><b>:&nbsp;&nbsp;</b><%=ipd.getMidarmcircumference()%>
												</span>
											</div>
										</div>
										<%
...
if(!loginInfo.isBalgopal()) {
	bal="hidden";
									...
									<div
										class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-right <%=bal%>">
										<div class="form-group marbot3"
											style="margin-bottom: 0px !important;">
											<b for="inputEmail3" class="control-label newdcard2">
												Barcode </b>
									...
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8  <%=bal%>"
...
<%if(ipdForm.getDecData()!=null){ %>
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
					style="padding-top: 10px">
				<%if(ipdForm.getDecData().getDeclarationTitle()!=null){ %>
				<h5 class="text-left titleset" style="color: #6699cc;">
						<b><%=ipdForm.getDecData().getDeclarationTitle()%></b>
					</h5>
				
				<div>
				<%=ipdForm.getDecData().getDeclarationNotes()%>
				</div>
				<%} %>
				</div>
				<%} %>
			...
			<%if(loginInfo.isBams1()){ %>	
				<%if(!DateTimeUtils.isNull(ipdForm.getDiet().getOndiet()).equals("")){ %>
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
					style="padding-top: 10px">
				<h5 class="text-left titleset" style="color: #6699cc;">
						<b>Diet Advice</b>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-left"
							...
							<table class="table" style="width: 100%;">
								<thead style="color: #6699cc;">
									<tr>
									 <s:if test="finalConditions.size!=0">
										<td style="width: 100%;">
											<h4 class="text-left titleset">
												<b>FINAL DIAGNOSIS</b>
											</h4>
										</td>
										<td style="" class="hidden">
											<h4 class="text-left titleset" style="color: #6699cc;">
...
%>
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
					<%
			           if (ipd.getChiefcomplains() != null || ipd.getAlergies() != null || ipd.getAlergies() != null) {
		            %>
						<h4 class="text-left titleset" style="color: #6699cc;">
							<b> <%=kunalnew %> SUMMARY
							</b>
 ...
 %> <s:if test="useregno!=null">| Reg No:<s:property
															value="useregno" />
													</s:if> <%--  <s:property value="doctor_phone"/> --%></span>
											</div>
										</div>
									</div>
			...
			%>
							...
							<div
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
										...
										<div class="form-group">
											<p style="margin: 0 0 0px; font-size: 13px">
												<b>There is NO H/O -</b>
												<%
										if (("No").equals(ipd.getFpcondition())) {
									%>
								...
								%>
											<label for="exampleInputName2">Special Notes/Remarks
												: </label><span class="help-block" style="text-align: justify;"><%=ipd.getSpecialnotes()%>
											</span>
											<%
									}
								%>
				...
				<s:if test="nicuaccess">
					<div class='col-lg-12 col-md-12 col-xs-12 col-sm-12'>
						<%if((!ipd.getMaternal_history().equals(""))||(!ipd.getPerinatal_history().equals(""))){%>
						<h4 class="text-left titleset" style="color: #6699cc;">
							<b> NICU HISTORY</b>
							<%} %>
						</h4>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12  "
							style="padding: 0px; padding-top: 10px !important;">
			...
			%>
					...
					if(DateTimeUtils.removeBreaks(ipd.getPasthistory()) == null || DateTimeUtils.isNull(ipd.getPasthistory()).equals("") || DateTimeUtils.isNull(ipd.getPasthistory()).equals("<br>")){
						pastflag=false;
					}
						if (pastflag) {
					%>
					...
					%>
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="form-group">
										<b for="exampleInputName2">SURGICAL HISTORY </b>
									</div>
...
if(ipd.getDiethist().equals("")&&ipd.getDevelopmenthist().equals("")&&ipd.getBirthhist().equals("")&&ipd.getEmmunizationhist().equals("")){ %>
				...
				%>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
						<div class="col-lg-2 col-md-2 col-xs-2 col-sm-2 "
							style="padding: 0px;">
							<div class="form-group">
								<b for="exampleInputName2" style="text-transform: uppercase;">BIRTH
									HISTORY</b>
							</div>
						</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
						<div class="col-lg-2 col-md-2 col-xs-2 col-sm-2 "
							style="padding: 0px;">
							<div class="form-group">
								<b for="exampleInputName2" style="text-transform: uppercase;">IMMUNIZATION
								</b>
							</div>
						</div>
				...
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
					<h4 class="text-left titleset" style="color: #6699cc;">
						<b><s:if test="nicuaccess"></s:if>
							<s:else>ON</s:else> EXAMINATION</b>
					</h4>
				</div>
...
<s:if test="dischargeStatusId==3">
				...
				%>
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
						...
						<div class=" " style="padding-top: 10px;">
							<h4 class="text-left titleset" style="color: #6699cc;" id="otn2">
								<b>OPERATIVE NOTES</b>
							</h4>
						</div>
						...
						%>
						<%
						Bed treatmentEpisode = (Bed) request.getAttribute("treatmentEpisodeData");
						%>
						<%
						ipdForm.setSurgeon(DateTimeUtils.isNull(ipdForm.getSurgeon()));
						if (!ipdForm.getSurgeon().equals("")) {
						%>
						<div class="col-lg-3 col-md-3 col-sm-3" style="padding: 0">
							<div class="form-group">
						...
						<%
						} else if (!treatmentEpisode.getOt_manual_surg().equals("")) {
						%>
						<div class="col-lg-3 col-md-3 col-sm-3" style="padding: 0">
							<div class="form-group">
								<label style="padding: 5px"><b>OPERATING SURGEON</b></label>
								<p for="exampleInputName2"
									style="margin: 0 0 0px; font-size: 13px; text-align: justify; padding: 5px">
									<%=treatmentEpisode.getOt_manual_surg().toString()%></p>
						...
						<%
						ipdForm.setAnesthesiologist(DateTimeUtils.isNull(ipdForm.getAnesthesiologist()));
						if (!ipdForm.getAnesthesiologist().equals("")) {
						%>
						<div class="col-lg-3 col-md-3 col-sm-3" style="padding: 0">
							<div class="form-group">
						...
						<%
						} else if (!treatmentEpisode.getOt_manual_anesthesio().equals("")) {
						%>
						<div class="col-lg-3 col-md-3 col-sm-3" style="padding: 0">
							<div class="form-group">
								<label style="padding: 5px"><b>ANESTHESIOLOGIST</b></label>
								<p for="exampleInputName2"
									style="margin: 0 0 0px; font-size: 13px; text-align: justify; padding: 5px">
									<%=treatmentEpisode.getOt_manual_anesthesio().toString()%></p>
							</div>
						</div>
						<%
						}
		...
		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12  "
			...
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-left"
				...
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
					...
					<div class="form-group">
						<div style="padding-left: 0px;">
							...
							<p>
								<%
								ipdForm.setTreatmentgiven(DateTimeUtils.isNull(ipdForm.getTreatmentgiven()));
								%><%=ipdForm.getTreatmentgiven().toString()%></p>
						</div>
					</div>
				</div>
				<%
				...
				<s:else>
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
						...
						if ((dischargePriscList.size() > 0
								|| !(DateTimeUtils.removeBreaks(ipdForm.getKunal_manual_medicine_text()).equals("")))) {
						%>
						<h4 class="text-left titleset" style="color: #6699cc;">
									...
									<s:if test="dischargePriscList.size>0">
										<table class="table table-bordered">
											...
											<tbody>
												...
												<tr>
													<td><%=priscsrno%></td>
													<td class="uppercaseirf <%=respiraMedText%>"><%=priscription.getMdicinenametxt()%></td>
													<%
													priscription.setDosenotes(DateTimeUtils.isNull(priscription.getDosenotes()));
													%>
													<td><%=priscription.getDosenotes().toString()%></td>
				...
				<%
					ArrayList<Bams> mainArrayList=ipdForm.getMainArrayList();
				%>
					...
					<%if(mainArrayList.size()>0){%>
						...
						<thead>
							...
							<tbody>
							  ...
							  <%
	for (Bams bams : mainArrayList) {
  %>
								<tr>
									<td><%=bams.getShowDate() %></td>
									<td>
									<%if(bams.getVitalList().size()>0){ %>
									
										<div><h6 class="text-left titleset">Vital</h6></div>
										
										 <%for(Bams bams1:bams.getVitalList()){ %>
											<div>
												Height:
												<%=bams1.getHeight() %>|
										...
										<%} %>
										<%if(bams.getPriscList().size()>0){ %>
										<div><h6 class="text-left titleset">Prescription</h6></div>
										<table class="table table-bordered">
										<thead>
											<tr>
											<th>Sr</th>
											...
											<%int u=1; %>
											<tbody>
											<%for(Priscription priscription:bams.getPriscList()){ %>
										...
										<%if(bams.getInvestList().size()>0){ %>
										
										<div><h6 class="text-left titleset">Investigation</h6></div>
										<table class="table table-bordered">
										<thead>
											<tr>
											<td>Sr</td>
											...
											<%int v=1; %>
											<tbody>
											<%for(Investigation investigation:bams.getInvestList()){ %>
											
												<tr>
												<td><%=v++ %></td>
												<td><%=investigation.getName()%></td>
												<td><%=investigation.getInvstname() %></td>
												<td><%=investigation.getObsvalue() %></td>
												<td><%=investigation.getInvstUnit() %></td>
										...
										<%if(bams.getPunchList().size()>0){ %>
										
										<div><h6 class="text-left titleset">PunchKarma</h6></div>
										<table class="table table-bordered">
										<thead>
											<tr>
											<td>Sr</td>
											<td>Punchkarma Type</td>
											<td>Notes</td>
											...
											<%int w=1; %>
											<tbody>
											<%for(Duty duty:bams.getPunchList()){ %>
											
												<tr>
												<td><%=w++ %></td>
												<td><%=duty.getProcedureid() %></td>
												<td><%=duty.getNote() %></td>
										...
										<table class="table table-bordered">
										   <thead>
											...
											<%int z=1; %>
										  <tbody>
											<%for(Duty duty1:duty.getPunchkarmadata()){ %>
												<tr>
												<td><%=z++ %></td>
												<td><%=duty1.getDate_time() %></td>
												<td><%=duty1.getNote() %></td>
			...
			<%} %>
										...
										<%if(bams.getPhysioList().size()>0){ %>
										
										<div><h6 class="text-left titleset">Physio</h6></div>
										<table class="table table-bordered">
										<thead>
											<tr>
											<td>Sr</td>
											...
											<%int w=1; %>
											<tbody>
											<%for(Bed bed:bams.getPhysioList()){ %>
			...
			<%} %> 	
				...
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
					style="padding-top: 10px">
					<h4 class="text-left titleset" style="color: #6699cc;">
						<b>How and When Get Emergency Details</b>
					</h4>
				...
				%>
				<%
				if (ipdForm.getDailynoteslist() != null) {
				%>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
					style="padding: 0px;">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
							<b for="exampleInputName2"> <s:if test="daycare">PROCEDURE</s:if>
								NOTES
							</b>
						</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
							style="padding-left: 0px;">
							<div class="form-group">
							<%for(Accounts accounts:ipdForm.getDailynoteslist()){%>
								<p><%=accounts.getDate_time().split(" ")[0]%> :- <%=accounts.getNotes()%></p>
								<%} %>
							</div>
				...
				<div class="">
					<div class="col-lg-12 col-md-12 col-xs-12 " style="padding: 0px;">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padsign"
							style="padding-top: 70px !important; margin-left: -10px !important">
 ...
 %> <s:property value="qualification" />
										...
										%></span><br> <span>[FOR <s:property value="clinicName" />]
									</span> <br> <br>
								</div>
							</s:if>
							<s:else>
								<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left"
									...
									<s:if test="qualification==null||qualification==''"></s:if>
									<s:else>
									...
									<br> <span>[FOR <s:property value="clinicName" />]
									</span> <br> <br>
								</div>
							...
							<s:if test="mlccase==1">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-centre">
									<span><s:property value="mlcrefdoctor" /></span><br> <span>[FOR
						...
						<div class='col-lg-12 col-md-12'>
							...
							<div class='col-lg-12 col-md-12'>
								...
								%>
								<span>Nature of illness, prognosis, risk & complications
									of disease explained to the parents & relatives in detail.</span><br>
								<span>All the above medicines are explained to me and I
									understood them. All investigations Report including Radiology
									report & film are handed over to me.</span><br> <span>सभी
									जांच रिपोर्ट और रेडियोलॉजिकल रिपोर्ट और फिल्म मुझे सौंपी गई है
									|</span> <br>
								<br>
								<br>
								<br>
								...
								<s:if test="!nicuaccess">
									...
									<span style="margin-right: 10px">Admitted By: <s:property
											value="addmitedbyuserid" /> <s:property
											value="admissiondate" /></span>
									<br>
									<s:if test="dischargeStatusId==3">
									...
									<span style="margin-right: 10px">Printed By: <s:property
											value="printedBy" /></span>
									<br>
								</s:if>

								<span class='hidden-print' style="margin-right: 10px">Updated
									By: <s:property value="dischargteLastUpdatedId" />
								</span> <br> <span class='hidden-print' style="margin-right: 10px">Ended
									By: <s:property value="enddischargename" />
								</span>
