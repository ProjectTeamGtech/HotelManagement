...
<%-- 	<div class="letterheadhgt" >
	...
	<div class="row" style="padding-top: 100px;">
		...
		<div class="col-lg-12 col-xs-12 col-md-12 " style="font-weight: bolder;" >
		...
		<div class="col-lg-12 col-xs-12 col-md-12" style="padding: 0px; background-color: rgba(91, 192, 222, 0.16);">
			...
			<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
				<div class="form-group">
					...
					<p><s:property value="doctor_name" />( <s:property value="discipline" /> )</p>
				</div>
			</div>
			...
			<div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
				<div class="form-group">
	               ...
	               <p> <s:property value="agegender" /></p>
				</div>
			</div>
			<div class="col-lg-12 col-xs-12 col-md-12" style="padding: 0px; background-color: rgba(91, 192, 222, 0.16);">
			<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
	...
	<div class="col-lg-12 col-xs-12 col-md-12" style="padding: 0px; background-color: rgba(91, 192, 222, 0.16);">
		...
		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 settopad">
			...
			<%if(!DateTimeUtils.isNull(ipdForm.getPulse()).equals("")){ %>
				...
				<div class="col-lg-2 col-md-2 col-xs-2 col-sm-2">
					<label><b>R/R:</b></label>
					<s:property value="respiratory_rate" />
				</div>
				<%} %>
			...
			<%if(!DateTimeUtils.isNull(ipdForm.getChiefcomplains()).equals("")){ %>
				<div class="col-lg-12 col-xs-12 col-md-12 " style="margin-bottom: 5px;">
					<label>CHIEF/PRESENT COMPLAINTS AND REASON</label>
				</div>
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin-bottom: 15px;">
					<div class="form-group" style="margin-top: 10px;">
			...
			<div class="">
								...
								<tbody id="dischargedataid">
									<%for(Priscription priscription:dischargePriscList){ %>
										<tr>
											...
											<td class="uppercaseirf " style="text-align: center;">
				...
				<%if(!DateTimeUtils.isNull(ipdForm.getDiscadvnotes()).equals("")){ %>
					<div class="">
						<div class="col-lg-12 col-xs-12 col-md-12" style="margin-bottom: 15px;">
							<label>
								ADVICE/FOLLOW UP
							</label>
						</div>
