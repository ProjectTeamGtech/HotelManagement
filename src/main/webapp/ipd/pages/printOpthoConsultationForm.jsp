...
%>
	...
	<div class="col-lg-12 col-xs-12 col-md-12" style="padding: 0px; background-color: rgba(91, 192, 222, 0.16);">
		...
		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 settopad">
			<%if(!DateTimeUtils.isNull(ipdForm.getLSplRFI()).equals("")
			|| !DateTimeUtils.isNull(ipdForm.getLCylRFI()).equals("")
			|| !DateTimeUtils.isNull(ipdForm.getLAxisRFI()).equals("")
			|| !DateTimeUtils.isNull(ipdForm.getRSplRFI()).equals("")
			|| !DateTimeUtils.isNull(ipdForm.getRCylRFI()).equals("")
			|| !DateTimeUtils.isNull(ipdForm.getRAxisRFI()).equals("")
			...
			<div class="col-lg-12 col-xs-12 col-md-12 col-sm-12" style="margin-bottom: 15px;">
				<%if(!DateTimeUtils.isNull(ipdForm.getLSplRFI()).equals("")){ %>
					<div class="col-lg-1 col-md-1 col-xs-12 col-sm-12">
						<label><b>L.Spl RFI:</b></label>
						<s:property value="LSplRFI"/>
					</div>
				<%} %>
				<%if(!DateTimeUtils.isNull(ipdForm.getLCylRFI()).equals("")){ %>
				<div class="col-lg-1 col-md-1 col-xs-12 col-sm-12">
					<label><b>L.Cyl RFI:</b></label>
					<s:property value="LCylRFI"/>
				</div>
				<%} %>
				<%if(!DateTimeUtils.isNull(ipdForm.getLAxisRFI()).equals("")){ %>
				<div class="col-lg-1 col-md-1 col-xs-12 col-sm-12">
					<label><b>L.Axis RFI:</b></label>
					<s:property value="LAxisRFI"/>
				</div>
				<%} %>
				<%if(!DateTimeUtils.isNull(ipdForm.getRSplRFI()).equals("")){ %>
				<div class="col-lg-1 col-md-1 col-xs-12 col-sm-12">
					<label><b>R.Spl RFI:</b></label>
					<s:property value="RSplRFI"/>
				</div>
				<%} %>
				<%if(!DateTimeUtils.isNull(ipdForm.getRCylRFI()).equals("")){ %>
				<div class="col-lg-1 col-md-1 col-xs-12 col-sm-12">
					<label><b>R.Cyl RFI:</b></label>
					<s:property value="RCylRFI"/>
				</div>
				<%} %>
				<%if(!DateTimeUtils.isNull(ipdForm.getRAxisRFI()).equals("")){ %>
				<div class="col-lg-1 col-md-1 col-xs-12 col-sm-12">
					<label><b>R.Axis RFI:</b></label>
					<s:property value="RAxisRFI"/>
				</div>
				<%} %>
		...
		<%if(!DateTimeUtils.isNull(ipdForm.getChiefcomplains()).equals("")){ %>
			...
			<%} %>
			<br>
			<%if(!DateTimeUtils.isNull(ipdForm.getEyereading()).equals("")){ %>
				<div class="col-lg-12 col-xs-12 col-md-12 textprime" style="margin-bottom: 5px;">
					<h5>EYE VISION</h5>
				</div>
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin-bottom: 15px;">
					<div class="form-group" style="margin-top: 10px;">
						<%=ipdForm.getEyereading().toString()%>
					</div>
				</div>
			<%} %>
