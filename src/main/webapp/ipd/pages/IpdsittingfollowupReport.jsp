		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
					...
					<h4 style="font-size: 17px; font-weight: 600; color: white">Session Report</h4>
				</div>
			</div>
		</div>
		<div class="row ">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				...
				<s:form action="IpdsittingandfollouprptChargesRpt" id="deptfrm" theme="simple">
					<s:hidden name="clientId" id="clientId"></s:hidden>
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 topback2  hidden-print"
							style="display: flex; flex-wrap: wrap;">
							<div class="col-lg-1 col-md-1 col-xs-12 col-sm-12 hidden">
							...
							<div  class="col-lg-2 col-md-2 col-xs-12 col-sm-12">
								...
								<%
									if (loginInfo.getSuperadminid() == 1 || loginInfo.getUserType() == 2
												|| !loginInfo.getShow_dept_opd_list().equals("0") || loginInfo.getJobTitle().equals("PHYSIO RECEPTION")) {
								%>
							...
							<div hidden class="col-lg-1 col-md-2 col-xs-12 col-sm-12" id="sittingDiv">
								<label>Sitting</label>
							...
							<div hidden class="col-lg-2 col-md-2 col-xs-12 col-sm-12" id="procedureMasterDiv">
							...
							<div hidden class="col-lg-2 col-md-2 col-xs-12 col-sm-12" id="procedureDiv">
							...
							<!-- For Physio Ipd -->
							<div hidden class="col-lg-1 col-md-1 col-xs-12 col-sm-12">
								<label>Type</label>
							...
							<div class="col-lg-2 col-md-2 col-xs-12 col-sm-12 hidden" style="padding-top: 22px; text-align: right; margin-right: 22px;">
								...
								<table
									...
									<thead style="text-align: center;">
										<tr>
											...
											<td>Department</td>
											<td>Session Name</td>
											<td class="hidden">Procedure Master Name</td>
											<td class="hidden">Procedure Name</td>
											<td >Session No</td>
											<td>Remark</td>
											<%if(loginfo.isPhysio()){ %>
											<td>Diagnosis</td>
									...
									<tbody style="text-align: center;" >
                                       <%
						                int i = 1;
					                   %>
										<s:iterator value="SessionsittingAndFolloUpList">
											<tr>
												<td><%=i++%></td>
												...
												<td class="hidden"><s:property value="procedureMasterName" /></td>
												<td class="hidden"><s:property value="procedureName" /></td>
