...
<%-- <s:hidden id="admi_disc_ipd_prisclist"></s:hidden> --%>
  ...
  <!-- by lokesh -->
                                        ...
                                        <%-- Commenting for parihar <%=pediatric_histry %>   --%>                                
 ...
 --%>		        
             ...
             <input type="button" class="btn btn-info" onclick="getIPDTempData1()" value="Get Data"  align="right" style="width:10%;"/>
                               ...
                               <div class="">
		                         	...
		                         	<div class="col-lg-2 col-md-2 col-xs-2 col-sm-2 <%=gestage%>">
		                         	 <div class="form-group">
...
<div class='<%=nicuhide%>'>
		...
		<%
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
							...
							<div class="form-group">
								<label for="exampleInputName2"><b style="text-transform: uppercase;">Surgical History</b></label>
		...
		<div class="form-group">
			...
			<div class="form-group" >
			<s:textarea cssClass="form-control" rows="3" cols="5"  name="personalhist" id="personalhistlok"></s:textarea>
			</div>
		</div>
		<%-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
		<div class="form-group">
           ...
           <div class="form-group" style="margin-top:10px;">
            <s:textarea cssClass="form-control" rows="3" maxlength="" name="developmenthist" id="developmenthist"></s:textarea>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                              <div class="form-inline">
               <div class="form-group">
                 <label for="exampleInputName2"><b>IMMUNIZATION HISTORY</b></label>&nbsp;&nbsp;<span class="tooltip"><i class="fa fa-info-circle fa-2x"></i><span class="tooltiptext">"A history of the surgical proceduresâand complications, if anyâ that a particular person has had"></span></span>
               </div>
           </div>
					...
					<div class="row <%=sysreview%>">
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
							<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
								...
								<p>
									<%
										if (DateTimeUtils.isNull(ipd.getFpcondition()).equals("No")) {
									%>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-xs-12">
								...
								<div class="col-lg-2 col-md-2 col-xs-2 ">
									...
									<div class="form-group">
									<br>
									<label>Enter Surgeon (Manual)</label>
										<input type="text" class='form-control'  style="width: 100%"  value="<s:property value='treatmentEpisodeData.ot_manual_surg'/>"  onchange="saveDischargeFieldsTreatmentEpisode(this.value,'ot_manual_surg','<s:property value="jsonipdid"/>')">
									</div>	 
								</div>
								<div class="col-lg-2 col-md-2 col-xs-2">
									<div class="form-group">
									...
									<div class="form-group">
									<br>
									<label>Enter Anesthesiologist (Manual)</label>
										<input type="text" class='form-control'  style="width: 100%"  value="<s:property value='treatmentEpisodeData.ot_manual_anesthesio'/>" onchange="saveDischargeFieldsTreatmentEpisode(this.value,'ot_manual_anesthesio','<s:property value="jsonipdid"/>')">
									</div>
								</div>
								<div class="col-lg-2 col-md-2 col-xs-2 ">
									<div class="form-group">
			...
			<div class="col-lg-12 col-xs-12 col-md-12 textprime">
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 <%=daycareaccess%>">
						<div class="form-inline" style="margin-top: 10px;">
							...
							<div class="form-group" >
							<input type="button" class='btn btn-success' value="Include Investigations" onclick="showdischargeInvestigation(<s:property value="clientid"/>)">
							</div>
									...
									<s:iterator value="dischargePriscList">
										<tr>
											<td><input type="number" class="form-control"
												name="dicpriscmed<s:property value="id"/>"
												value="<s:property value="dispriscsrno"/>"></td>
											<td class='medname'><s:property value="mdicinenametxt" /></td>
											<td>
												<select id="discpriscdose<s:property value="id"/>" name="discpriscdose<s:property value="id"/>" class="form-control chosen-select">
													<s:iterator value="dosageList">
														<s:if test="name==priscdose">
									...
									<s:iterator value="dischargePriscList">
										<tr>
											<td><input type="number" class="form-control"
												...
												value="<s:property value="dispriscsrno"/>"></td>
												<!--text-uppercase  -->
											<td class="uppercaseirf medname"><s:property value="mdicinenametxt" /></td>
											<td>
												<select id="discpriscdose<s:property value="id"/>" name="discpriscdose<s:property value="id"/>" class="form-control chosen-select">
													<s:iterator value="dosageList">
														<s:if test="name==priscdose">
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
						...
						<div class="form-inline">
							<div class="form-group" style="width: 100%;">
								...
								<input type="checkbox" onchange="setFollowUpDate(this.checked)" name='giveFollowUp' id='giveFollowUp'>
								<input type="text" readonly="readonly" placeholder="followup date" name="followupdate1" id='followupdate1' class='form-control' onchange="giveIpdFollowup(this.value)">
								<label class="" >&nbsp;&nbsp;&nbsp;&nbsp; Book Follow Up Apmt  &nbsp;&nbsp;</label><input type="checkbox" name='bkapmtipd' id='bkapmtipd' >
               ...
               <label for="exampleInputName2"><b><s:if test="daycare"><>PROCEDURAl</s:if> NOTES</b></label>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="form-group">
						<br>
               <label for="exampleInputName2"><b><s:if test="daycare"><>PROCEDURAl</s:if> On diet</b></label>
         </div>
							<div class="form-inline">
								<div class="form-group" style="width: 100%;">
									<s:select list="On_diet_list"
										onchange="getondiet(this.value)" listKey="id"
										listValue="name" cssClass="form-control" headerKey="0"
										headerValue="Select Template"></s:select>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="form-group">
						<br>
               <label for="exampleInputName2"><b><s:if test="daycare"><>PROCEDURAl</s:if> Physio</b></label>
         </div>
							<div class="form-inline">
								<div class="form-group" style="width: 100%;">
									<s:select list="Physio_list"
										onchange="getphysio(this.value)" listKey="id"
										listValue="name" cssClass="form-control" headerKey="0"
										headerValue="Select Template"></s:select>
									<input type="text" name="Physiotempname"
										...
										id="changer"></img> -->
								  <div class="form-group">
								      <img src="cicon/mic_off.png" class="img-responsive micimg12" onclick="startConverting155(this,'physio')" title="Microphone" id="changer" style="width: 2.5%;margin-right: 30px;margin-top: -16px;"></img>
								  </div>
