...
%>
	...
	<div class="col-lg-12 col-xs-12 col-md-12" style="padding: 0px; background-color: rgba(91, 192, 222, 0.16);">
		...
		<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 settopad">
			...
			<div hidden class="col-lg-12 col-xs-12 col-md-12 textprime" style="margin-bottom: 5px;">
				<h5>Vitals</h5>
			</div>
			<div hidden class="col-lg-12 col-xs-12 col-md-12 col-sm-12" style="margin-bottom: 15px;">
				<%if(!DateTimeUtils.isNull(ipdForm.getPulse()).equals("")){ %>
			...
			<%if(!DateTimeUtils.isNull(ipdForm.getInvestigation()).equals("")){ %>
				<div hidden class="col-lg-12 col-xs-12 col-md-12 textprime">
					<h5>INVESTIGATIONS 
					</h5>
				</div>
  ...
  %>
								<tr>
									...
									<%if(bams.getVitalList().size()>0){ %>
										...
										<thead>
											...
											<th>Sr</th>
											<th>Name of Drug</th>
											<th class="hidden">Req Qty</th>
											<th>Days</th>	
											<th>Dosage</th>
											<th class="hidden">Routes</th>
											<th>Strength</th>
											...
											<%for(Priscription priscription:bams.getPriscList()){ %>
												...
												<td class="hidden"><%=priscription.getNewqty() %></td>
												<td><%=priscription.getPriscdays() %> Days</td>
												<td><%=priscription.getRegional() %></td>
												<td class="hidden"><%=priscription.getDosenotes() %></td>
												<td><%=priscription.getStrength() %></td>
    ...
    <%if(ipdForm.getKarmaprocedure()!=null){ %>
		<%if(loginInfo.isBams1()){ %>
			<%if(!DateTimeUtils.isNull(ipdForm.getKarmaprocedure().getKarma()).equals("")){ %> 
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="col-lg-12 col-xs-12 col-md-12 textprime" style="margin-bottom: 15px;">
						<h5>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="form-group" style="margin-top: 10px;">
						<div>
		          <%=ipdForm.getKarmaprocedure().getKarma() %>
				</div>						
				 </div>
					</div>
		...
		<%} %>	
			...
			<%if(!DateTimeUtils.isNull(ipdForm.getKarmaprocedure().getProcedurebams()).equals("")){ %>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="col-lg-12 col-xs-12 col-md-12 textprime" style="margin-bottom: 15px;">
						<h5>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="form-group" style="margin-top: 10px;">
						<div>
				<%=ipdForm.getKarmaprocedure().getProcedurebams() %>
				</div>						
				 </div>
					</div>
