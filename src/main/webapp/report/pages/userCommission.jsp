	...
	<div class="col-lg-12 col-md-12 topback2 hidden-print">
		<div class="form-inline">
			...
			<div class="form-group">
				...
				<a href="#" onclick="opencPopup('PractitionerListOpdCommission?action=1')" class="colortog"> OPD Commision Report</a>   <!-- PractitionerList url chnage to PractitionerListOpd -->
			</div>
		</div>
