...
<div class="col-lg-12 col-md-12 paddingnil">
	...
	<%-- <div class="form-group">
		...
		<div class="form-group" style="width:12%" id="subcategorydiv">
	 ...
	 <div class="form-group">
		...
		<a href="#" onclick="printDiv5('printableArea')" class="btn btn-primary hidden-print"><i class="fa fa-print"></i></a>
	...
	<table class="table table-bordered table-striped tablexls" cellspacing="0" width="100%" id="example" style="margin-bottom: 0px;">
		<thead>
			<tr class="tableback">
				...
				<td class="thcoi" style="width: 7% ">Rate</td>
		...
		<tbody>
			...
			<s:iterator value="departmaterialissuelist">
				<tr>
					...
					<td><s:property value="pur_price"/></td>
