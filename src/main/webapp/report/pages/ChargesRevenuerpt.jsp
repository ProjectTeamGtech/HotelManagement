...
<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
	...
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
		<h4>Charges Wise Revenue Report</h4>
	</div>		
	</div>
	
	<div class='row'>
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 hidden-print ">
	<s:form action='ChargesRevenuerptReport'>
	<div class='form-inline'>
	  ...
	  <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
			...
			<div class="col-lg-2 col-md-2 col-xs-2 form-group"><label for="exampleInputEmail1" id="hstp">Search</label>
			       <s:textfield theme="simple" name="Searchtext" placeholder="Search By Code"  cssClass="form-control" />
		       </div> 
			<div class="form-group" >
	...
	<h1>Total count:<b><s:property value="FinalNewPatientCount" /></b></h1>
	<tr>
	<th>Sr. No</th>
	<th>Count</th>
	<th>Service</th>
