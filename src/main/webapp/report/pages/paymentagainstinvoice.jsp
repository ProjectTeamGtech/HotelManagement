								...
								<div class="row ">
									<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
										<div>
											...
											<s:form action="paymentagainstinvoice1ChargesRpt" id="paymentreportfrm" theme="simple">
...
<s:hidden name="actiontype" id="actiontype"/>
	<div class="col-lg-12 col-md-12 topback2 hidden-print">
		<div class="form-inline">
     	...
     	<% Map<Integer, Vector<Accounts>> chargeinvlist=(Map<Integer, Vector<Accounts>>) session.getAttribute("chargeinvlist"); %>
				...
				<table class="table" id="xlstable" style="width: 100%;border-top: 1px solid #ddd;">
					...
					<tbody>
						...
						<%for(Vector<Accounts> value:chargeinvlist.values()){ 
