...
<div class="col-lg-12 col-md-12 col-xs-12" id="printableArea" style="padding: 0px;">
...
<div id="page_printer">
	<table class="table tablexls" cellspacing="0" width="100%" id="" style="margin-bottom: 0px;">
		<thead>
			<tr class="loc">
				<td class="" style="width: 1%">Sr.no</td>
				<td class="" style="width: 49% ">Product Name</td>
				<td class="" style="width: 25% ">Stock</td>
				<td class="" style="width: 25% ">Status</td>
			 </tr>
		</thead>
		<tbody>
...
<s:form action="nonmovingitemReport" name="paginationForm" id="paginationForm" theme="simple">
							    
							     <s:hidden name="department"></s:hidden>
							     <s:hidden name="filteroforder"></s:hidden>
