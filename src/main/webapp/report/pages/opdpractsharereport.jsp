...
<%-- <s:form action="OPDPractitionerListCommission" theme="simple" id = "userFrm"> --%>   <!-- commented method name change nmeans url -->
<s:form action="PractitionerListOpdCommission" theme="simple" id = "userFrm">
