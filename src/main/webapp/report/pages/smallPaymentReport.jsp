			...
			<%-- 	<div class="col-lg-2 col-md-2 col-xs-2 col-sm-2">
				...
				<table id='smallpt' class="my-table xlstable" style="width: 100%" >
					...
					<tr class='thui'  style="background-color: orange;height: 25px;"><td colspan="12" style="text-align: center;"><b><s:property value="name"/></b></td></tr>
						...
						<!-- INVESTIGATION REFUND for Ayushman-->
						<s:if test="InvRefundList.size!=0">
							<tr class='thui'  style="background-color: orange;">
								<td colspan="14">Investigation Refund Payment</td>
							</tr>
							<s:iterator value="InvRefundList" status="rowstatus">
								<tr id="<s:property  value="id" />">
								<td><%if(loginfo.isBalgopal() || loginfo.isSeq_no_gen()){ %>(<s:property  value="bghseqId"  />)<%} %><s:property  value="id" /><%if(loginfo.isSeq_no_gen()){%>(<s:property value='physical_payment_id'/>)<%} %></td>
									<%-- <td><s:property value="refid"/></td> --%>
									<td></td>
									<td>Investigation Refund</td>
									<td><s:property value="userid" /></td>
									<td><s:property value="abrivationid" /></td>
									<td><s:property value="clientName" /></td>	
									<td><s:property value="payby" /></td>
							...
							<tr style="background-color: #009cd2;color: white;"><td colspan="12" style="text-align: center;"><b>Total Amount : <%=Constants.getCurrency(loginfo)%><s:property value="Invref"/></b></td></tr>
