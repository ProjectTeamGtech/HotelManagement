...
<div class="row">
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="durationdiv">
	
	<div class="col-lg-2 col-md-2 col-xs-12 col-sm-12">
		 <label id="compPractName"></label>
	</div>
	
	<div class="col-lg-2 col-md-2 col-xs-12 col-sm-12">
		<%--  <s:if test="%{#locationList != 'null'}" >
						<s:select cssClass="form-control" id="complocationid" name="locationid" list="locationList" listKey="locationid" listValue="location" headerKey="0" theme="simple" headerValue="All" />
		</s:if> --%>
	</div>
	
	<div class="col-lg-2 col-md-2 col-xs-12 col-sm-12"> 
		<s:textfield cssClass="form-control" readonly="true" placeholder="Date" name="date" id="date"/>
	</div>
	
	<div class="col-lg-3 col-md-3 col-xs-12 col-sm-12"> 
		<span id="patientpkgspan">
				<select name="ipdpackage" id="ipdpackage" class="form-control">
...
<table class="table table-bordered" cellspacing="0" width="100%">
												...
												<tr>
													...
													<td>
														...
														<s:select theme="simple" name="masterchargetype" id="masterchargetype" list="masterChageTypeList" listKey="name" listValue="name"
															...
															onchange="filterEmrCharges(this.value)"/>
														</div>
									...
									<input id="addchargebtn" type="button" value="Add Charge" onclick="setChargeAmountEmr()" disabled="disabled" class="btn btn-primary" style="float:right;">
									</div>
									</div>
</div>
</div>
