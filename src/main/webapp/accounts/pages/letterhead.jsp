...
<%} %>
	...
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="ltterimg"><%} %>
		...
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" id="lttertext"<%if(lll.isBalgopal() && !letterreq.isSaimed()){ %>style="text-align: center;"<%} %>>
	          ...
	          <%}else{ %>
			<div class="clinicname" id="clinicnamenew" style="font-size: 23px;">
			<%} %>
			...
			<div class="bottext">Phone:<s:property value ="landLine"/>,	<%if(letterreq.isBalgopal() && !letterreq.getClinicid1().equals("raibhattar") && !letterreq.getClinicid1().equals("raiprachi")){ %> Mobile: 7869920001<%} %><br>
			    Email: <s:property value = "clinicemail"/>
				<%-- <%if(!letterreq.isParihar()){ %><s:property value = "owner_qualification"/><%} %> --%>
