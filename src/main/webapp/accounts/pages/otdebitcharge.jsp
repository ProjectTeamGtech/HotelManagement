										...
										<tbody>
												<tr>	
													...
													<%if(!(loginfo.isAdd_manual_charge() || loginfo.isAdd_charge_amt_edit())){ %>
														<input  type="text" onchange="calcmanualcharge()" onkeypress="return isNumberKey(event,this);" style="text-align:right;" id="charge" name="charge" class="form-control" readonly="readonly"/>
													<%}else{ %>
...
<div class="col-lg-2 col-md-2 col-xs-12 col-sm-2" style="padding-left: 0px;">	
				<s:form action="createInvoiceAdditional" id = "createInvoiceAdditional">
					...
					<input type="button" id="opdcreateinvoicebtn" onclick="opdcreateinvoicedbl()" class="btn btn-primary" value="Create Invoice"/>
				</s:form>
		</div>  
		<div class="col-lg-2 col-md-2 col-xs-12 col-sm-2" style="padding-left: 0px;">	
				<s:form action="casdeskAdditional" id = "casdeskAdditional">
					...
					<input type="button" id="opdcashdeskbtn" onclick="opdcashdeskdbl()" class="btn btn-primary" value="Cash Desk"/>
				</s:form>
		</div>
