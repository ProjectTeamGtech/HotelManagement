				...
				<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding-left:0px;padding-right:0px;">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 text-right" style="padding-left:0px;padding-right:0px;">
						...
						<s:if test="payAmount > 0">
							...
							<span> / <label for="inputEmail3" class="control-label">UHID</label><span>: <s:property value="abrivationid"/></span></span><s:if test="ipdid==0|| ipdid==''"><span>&nbsp; | &nbsp;</span> <label for="inputEmail3" class="control-label">OPD ID</label><span>: <s:property value="opdid" /></span></s:if>
						</div>
						...
						<%if(loginfo.isSeq_no_gen()){%>
						<div class="form-group marbot3" style="margin-bottom: 1px;">
						<label for="inputEmail3" class="control-label">Receipt ID:</label><span> 
								...
								<s:iterator value="masterAssessmentList">
	                              <tr class="totalbor">
	                                    ...
	                                    <%if(loginfo.isSramhosp() || loginfo.getClinicid1().equals("dentalcl")){ %>
											 <s:property value=""/>  <!-- for sramhospital hide masterchargetype -->
									    <%}else{ %>
