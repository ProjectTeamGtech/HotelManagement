	...
	<%-- 					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 text-left" style="padding-left:0px;padding-right:0px;">
						...
						<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
							...
							<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
							<span style="font-size: <%=font%>"><s:property value="agegender" /></span>
							</div>
						</div>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group marbot3" style="margin-bottom: 1px;">
						  <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
							...
							<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
							<span><s:property value="address"/>, <s:property value="clienttown"/>, <s:property value="clientpostcode"/> </span> 
							</div>
						</div>
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group marbot3" style="margin-bottom: 1px;">
						    <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
						...
						<div class="col-lg-1 col-md-1 col-xs-1 col-sm-1">
						 ...
						 <div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">	
							<span><s:property value="tokenno"/></span>
						</div>
						</div>
						<%} %>
					...
					<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 " style="padding-left:0px;padding-right:0px;">
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group marbot3" style="margin-bottom: 3px;">
							 ...
							 <div class="col-lg-1 col-md-1 col-xs-1 col-sm-1">
							  ...
							  <div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
							 <span style="font-size : <%=font %>"><s:property value="dateTime"/></span>
							 </div>
							  <%} %>
							 <%
						...
						<%-- 	<s:else>
							...
							<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group" style="margin-bottom: 1px;">
							<s:if test="ipdid==0">
								<s:if test="opdid!=0">
									<%if(loginfo.isLmh()){ %>
					...
					<%-- 	<%if(loginfo.isBalgopal()){ %>
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group marbot3" style="margin-bottom: 1px;">
						    ...
						    <div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
							<span><s:property value="payeename"/></span>,
							</div>
							<s:if test="policyNo!=''">
