...
<div id="login_main">
	<div id="login">
		  ...
		  <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 " >
		  		...
		  		<%if(loginfo.getClinicid1().equals("raiprachi")){ %>
					...
					<div id="newpost" class="col-lg-12 col-md-12 col-xs-12 col-sm-12 borderbot">
							<link href="common/css/printpreview.css" rel="stylesheet" />
						<%if(!loginfo.isHidelogobillinv()){ %>
							<%@ include file="/accounts/pages/letterheadmark.jsp" %>
						<%} %>
					</div><%} %>
				</div> --%>
				<div class="row letterheadhgt" style="height: 135px;">
		...
		<div id="newpost" class="col-lg-12 col-md-12 col-xs-12 col-sm-12 borderbot">
			...
			<%}else {%>
				...
				int val=0;
				%>
				<h2 style="text-align: center;" id="hospital_heading"><strong ><%=list.get(val).getClinicName().toString() %></strong></h2>
		...
		<div class="col-lg-1 col-md-1"></div>
				...
				<div class="row" id='ml'>
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 " style="padding-top: 5px;border-bottom: 1px solid #6699cc;padding-bottom: 5px;">
					<div class="">
	...
	<%-- 					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
					...
					<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 text-left" style="padding-left:0px;padding-right:0px;padding-top: 10px;">
						...
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group marbot3" style="margin-bottom: 1px;<%=nowrap%> ">
							<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
							<label for="inputEmail3" class="control-label"><%=loginfo.getPatientname_field() %> </label>
							</div>
							<div class="col-lg-1 col-md-1 col-xs-1 col-sm-1">
							<label>:</label>
							</div>
							<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
							<span style="font-size: <%=font%>;"><s:property value="client"/> </span>
							</div>
							<span class="hidden-print">&nbsp; <%-- <%if(notpcsadmin){ %> |<%if(loginfo.isSjivh()){%>&nbsp;</span>
							<label for="inputEmail3" class="control-label ">Owner Name</label>
							<span class="" style="font-size: <%=font%>;">: <s:property value="Owner_name" /></span>&nbsp;|<%} %> &nbsp;
							<label for="inputEmail3" class="control-label hidden-print">Age / Gender</label>
							<span class="hidden-print" style="font-size: <%=font%>;">: <s:property value="agegender" /></span><%} %> --%>
						</div>
						<%--  <%if(notpcsadmin){ %>
						<div class="form-group visible-print hidden-lg hidden-md hidden-sm hidden" style="margin-bottom: 3px;<%=nowrap%>">
							<label for="inputEmail3" class="control-label">Age / Gender</label><span style="font-size: <%=font%>">: <s:property value="agegender" /></span>
						</div>
						<%} %>			 --%>			
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group marbot3" style="margin-bottom: 1px;">
<%-- 							<label for="inputEmail3" class="control-label">Address</label><span>: <s:property value="address"/>, <s:property value="clienttown"/>, <s:property value="clientpostcode"/> </span> 
 --%>					<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
                           <label for="inputEmail3" class="control-label">UHID</label>
                        </div><div class="col-lg-1 col-md-1 col-xs-1 col-sm-1">
							<label>:</label>
							</div>
							<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
						...
						<div class="form-group marbot3 hidden" style="margin-bottom: 1px;">
					...
					<%}else{ %>
					<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 " style="padding-left:0px;padding-right:0px;padding-top: 10px;">
						<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 form-group marbot3" style="margin-bottom: 3px;">
							 <%if(true){ %>
							 <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
							 <label for="inputEmail3" class="control-label">Invoice Date </label>
							 </div>
							...
							<div class="col-lg-5 col-md-5 col-xs-5 col-sm-5">
							 <span style="font-size : <%=font %>"><s:property value="Markinvdate"/></span>
							 </div>
							  <%} %>
							 <%
					...
					<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 0px;">
						<div class="table-responsive"> 
							<table class="table"> 
								...
								<%if(!loginfo.isSramhosp()){ %>
									<%if(!loginfo.isBalgopal()){ %>
										<td class="hidden"><s:property value="tpcode"/>
										</td>
										<td></td>
								<%} %>
								<%}else {%>
...
function thermalPrint(val){
	if(val.checked){
		document.getElementById('printSetting').className="thermal";
