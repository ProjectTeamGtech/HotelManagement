...
<div class="row">
	...
	<div class="col-lg-6 col-md-8">
		<div class="panel panel-primary">
			...
			<s:hidden id="departmentid" name="departmentid" />
				...
				<s:select list="locationlist" name="departmentid"  disabled="true" listKey="id" listValue="name" headerKey="0" headerValue="Select Department" cssClass="form-control chosen-select"></s:select>
				<br>
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-8">
			...
			<a class="btn btn-primary" onclick="updateshelf()">Update</a>
