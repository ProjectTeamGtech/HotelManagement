...
<s:form action="" id="viewProfile" theme="simple">
<div class="col-lg-12 col-md-12 col-sm-12 topback2 hidden-print">
	
	<div class="col-lg-3 col-md-3 hidden-print">
		<s:select name="dectitle" id="dectitle" list="declarationlist"
		listKey="id" listValue="name" cssClass="form-control chosen-select" onchange="generatedeclaration(this.value)"
...
<s:form action="printpayrollOtherTemplate" id="savedeclarationform">
	<s:hidden name="declarationNotes" id="declarationNotes1"></s:hidden>
<s:hidden name="declarationTitle" id="declarationTitle1"></s:hidden>
	<input type="hidden" value='<s:property value="Declarationtitle"/>' name="declarationTitle12">
