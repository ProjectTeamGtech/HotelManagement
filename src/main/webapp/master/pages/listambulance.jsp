...
<div class="col-lg-12 col-md-12 topback2">
	<div class="col-lg-3 col-md-2">
		...
		<div class="col-lg-1 col-md-1">
			<a class="btn btn-primary" href="#" onclick="opencPopup('addAmbulance')"><i
	...
	<s:form action="Ambulance">	
		<div class="col-lg-3 col-md-2">
			<s:textfield theme="simple" name="searchText" placeholder="Search By Vehicle No."  cssClass="form-control" />
...
<%if(loginInfo.getSuperadminid()==1){ %>
	<div class="col-lg-12 col-md-12">
		<a href="setvaccinationVaccination" class="btn btn-primary">Vaccination</a>
...
<table id="results"
	...
	<thead>
		<tr>
			...
			<th class="text-center">Type of Ambulance</th>
	...
	<tbody>
		<s:if test="Ambulancelist!=null">
			<s:iterator value="Ambulancelist" status="rowstatus">
				<tr>
					<td class="text-center"><s:property value="id" /></td>
					<td class="text-center"><s:property value="vehicleno" /></td>
					<td class="text-center"><s:property value="ambulancetype" /></td>
					<td class="text-center"><s:property value="driverfname"/></td>
					<td class="text-center"><a href="#" onclick="opencPopup('editAmbulance?selectedid=<s:property value="id" />')"> <i class="fa fa-edit"></i> </a></td>
					<td class="text-center"><a href="deleteAmbulance?selectedid=<s:property value="id"/>"
...
<s:form action="Ambulance" name="paginationForm" id="paginationForm"
	theme="simple">
