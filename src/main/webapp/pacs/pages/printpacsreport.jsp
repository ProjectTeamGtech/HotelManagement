	...
	<div class="row headw " >
		...
		<%-- 	<div  class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
			...
			<div class="form-group" style="margin: 0px;">
					...
					<label for="inputEmail3" class="control-label">Requested By<span style="font-weight: normal;">: <s:property value="reqdiaryUser"/></span>
						
					<%if(loginInfo1.getInvestigation_newaccess().equals("0") || loginInfo1.isLmh()){ %>
	...
	<div class="col-lg-1 col-md-1"></div>
		...
		if(loginInfo1.getClinicUserid().equals("vermanh")){
			...
			vermahospital="hidden";
					...
					<label for="inputEmail3" class="control-label hidden">User ID</label><span hidden>: <s:property value="userid"/> | --%> 
<table class="table" cellspacing="0" width="100%"  onmouseover=""  >
<tbody>

<%String finding=(String)session.getAttribute("finding"); %>
 <td><%=finding %></td>
...
<div class="col-lg-12 col-md-12 col-xs-12">
    ...
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding-left:20%;  text-align: center; padding-top: 5px;">
                                    <form class="form-inline">
                                        <div class="form-group docsig">
                                        <%String findinguser=(String)session.getAttribute("findinguser"); %>
                                        <b class="hidden-print">Verified By:</b> <b><%=findinguser %></b>
                                        </div>
                                        </form>
                                        </div>
