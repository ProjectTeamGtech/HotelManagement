...
public class Appointment {
	...
	public void setDrcompleted(String drcompleted) {
	...
	public String getAppointmentTypeTime() {
		return appointmentTypeTime;
	}

	public void setAppointmentTypeTime(String appointmentTypeTime) {
		this.appointmentTypeTime = appointmentTypeTime;
	}

	private String drcompleted;
	private String appointmentTypeTime;
