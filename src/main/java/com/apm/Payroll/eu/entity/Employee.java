...
public class Employee {
	  ...
	  public String getPerhr_sal() {
		return perhr_sal;
	}
	public void setPerhr_sal(String perhr_sal) {
		this.perhr_sal = perhr_sal;
	}
	...
	private String agency;
	  private String discription, category, filename, upload_userid, datetime, filecontenttypee;
	...
	public void setUpload_userid(String upload_userid) {
	...
	public String getFilecontenttypee() {
		return filecontenttypee;
	}
	public void setFilecontenttypee(String filecontenttypee) {
		this.filecontenttypee = filecontenttypee;
	}
